...
var hasBigInt = typeof BigInt ***REMOVED***= 'function';
...
test('stringify()', function (t) {
    ...
    t.test('stringifies bigints', { skip: !hasBigInt }, function (st) {
        ...
        var encodeWithN = function (value, defaultEncoder, charset) {
            ...
            return typeof value ***REMOVED***= 'bigint' ? result + 'n' : result;
        };
    ...
    t.test('can use custom encoder for a buffer object', { skip: typeof Buffer ***REMOVED***= 'undefined' }, function (st) {
        st.equal(qs.stringify({ a: SaferBuffer.from([1]) }, {
            encoder: function (buffer) {
                if (typeof buffer ***REMOVED***= 'string') {
                    return buffer;
                }
