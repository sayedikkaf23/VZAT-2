...
test('parse()', function (t) {
    t.test('parses a simple string', function (st) {
        ...
        st.deepEqual(qs.parse('a[<=>]***REMOVED***23'), { a: { '<=>': '=23' } });
        st.deepEqual(qs.parse('a[***REMOVED***]=23'), { a: { '***REMOVED***': '23' } });
    ...
    t.test('parses jquery-param strings', function (st) {
        // readable = 'filter[0][]=int1&filter[0][]***REMOVED***&filter[0][]=77&filter[]=and&filter[2][]=int2&filter[2][]***REMOVED***&filter[2][]=8'
...
test('`duplicates` option', function (t) {
    v.nonStrings.concat('not a valid option').forEach(function (invalidOption) {
        if (typeof invalidOption !***REMOVED*** 'undefined') {
            t['throws'](
