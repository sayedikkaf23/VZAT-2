...
test('Map', { skip: typeof Map !***REMOVED*** 'function' }, function (t) {
    var map = new Map();
    map.set({ a: 1 }, ['b']);
    map.set(3, NaN);
...
test('WeakMap', { skip: typeof WeakMap !***REMOVED*** 'function' }, function (t) {
    var map = new WeakMap();
    map.set({ a: 1 }, ['b']);
...
test('Set', { skip: typeof Set !***REMOVED*** 'function' }, function (t) {
    var set = new Set();
    set.add({ a: 1 });
    set.add(['b']);
...
test('WeakSet', { skip: typeof WeakSet !***REMOVED*** 'function' }, function (t) {
    var map = new WeakSet();
    map.add({ a: 1 });
...
test('WeakRef', { skip: typeof WeakRef !***REMOVED*** 'function' }, function (t) {
...
test('FinalizationRegistry', { skip: typeof FinalizationRegistry !***REMOVED*** 'function' }, function (t) {
...
test('Proxies', { skip: typeof Proxy !***REMOVED*** 'function' || !hasToStringTag }, function (t) {
