...
const Post_Vzat_Recurring_Data = async (req,res) => {
     if (!req.body) {
      ...
      try {
        ...
        else if(d.toISOString().slice(0,10) ***REMOVED***= CreatedDate){
        ...
        if(Array.isArray(req.body.Product_details)){
            if (req.body.Product_details.length ***REMOVED***= 0 || !OpportunityId || !quotepaymentId || !QuoteId  || !CreatedDate || !Status  || TotalPrice ***REMOVED***= null || TotalPrice ***REMOVED***= undefined || TotalPrice ***REMOVED***= 0 || Total_After_VAT_Currency__c ***REMOVED***= null || Total_After_VAT_Currency__c ***REMOVED***= undefined || Total_After_VAT_Currency__c ***REMOVED***= 0) {
                const data = {
                ...
                console.log(result);
                    for (let i = 0; i < req.body.Product_details.length; i++) {
                        if(!req.body.Product_details[i].QuoteLineItemId || req.body.Product_details[i].TotalPrice ***REMOVED***= null || req.body.Product_details[i].TotalPrice ***REMOVED***= undefined || req.body.Product_details[i].TotalPrice ***REMOVED***= 0 || req.body.Product_details[i].Total_Price_After_VAT__c ***REMOVED***= null || req.body.Product_details[i].Total_Price_After_VAT__c ***REMOVED***= undefined || req.body.Product_details[i].Total_Price_After_VAT__c ***REMOVED***= 0){
