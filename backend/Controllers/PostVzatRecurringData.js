...
const Post_Vzat_Recurring_Data = async (req, res) => {
  ...
  try {
    ...
    const createdDateObj = new Date(2025,0,10); // Year, Month (0 = Jan), Day
    ...
    const isDecemberSpecialCase = finalInstallmentType ***REMOVED***= "Installments" && month ***REMOVED***= 11;
    ...
    const isSubscription = finalInstallmentType ***REMOVED***= "Installments" && InstallmentLeft > 1;
    ...
    if (finalInstallmentType ***REMOVED***= "Installments" && InstallmentLeft > 0) {      
      ...
      for (let i = 0; i < InstallmentLeft; i++) {
        ...
        } else if (isDecemberSpecialCase && i ***REMOVED***= 1) {
