...
async function updatePaymentScheduleStatus(subscriptionId, paymentNumber, transactionId) {
  try {
    console.log('🔄 ***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***= UPDATING PAYMENT SCHEDULE ***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***=');
    ...
    console.log('🔄 ***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***= PAYMENT SCHEDULE UPDATE COMPLETE ***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***=');
    return { success: true };
  } catch (error) {
...
export const handleAFSWebhook = async (req, res) => {
  ...
  try {
    console.log('🔔 ***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***= AFS WEBHOOK RECEIVED ***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***=');
    ...
    console.log('  - Is DB (Direct Debit):', paymentType ***REMOVED***= 'DB');
    ...
    console.log('  - Is First Payment:', subscriptionRecord.subscription_status ***REMOVED***= 'pending' && (subscriptionRecord.payments_completed || 0) ***REMOVED***= 0);
    console.log('  - Success Condition Met:', paymentType ***REMOVED***= 'DB' && result.code.startsWith('000.'));
    ...
    if (paymentType ***REMOVED***= 'DB' && result.code.startsWith('000.')) {
      ...
      if (isFirstPayment) {
        ...
        console.log('🎉 ***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***= FIRST PAYMENT SUCCESSFUL ***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***=');
        ...
        console.log('🎉 ***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***= RECURRING PAYMENT SUCCESSFUL ***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***=');
