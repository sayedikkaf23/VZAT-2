        ...
        try {
          ...
          if (!customer) {
            ...
            if (cardInfo.brand) {
              ...
              if (firstDigit ***REMOVED***= '4') cardBrand = 'VISA';
              else if (firstDigit ***REMOVED***= '5') cardBrand = 'MASTERCARD';
              else if (firstDigit ***REMOVED***= '3') cardBrand = 'AMEX';
            }
