...
async function checkAndFixRegistrationId() {
  try {
    ...
    try {
      ...
      if (afsError.response?.data?.result?.code ***REMOVED***= '100.150.204') {
    ...
    console.log('\n🎉 ***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***= REGISTRATION ID CHECK COMPLETE ***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***=');
