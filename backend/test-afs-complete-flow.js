...
async function testCompleteRegistrationFlow() {
  ...
  console.log('***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***');
    ...
    try {
      ...
      if (statusResponse.data.result) {
        ...
        if (resultCode.match(/^(000\.000\.|000\.100\.1|000\.200)/)) {
          if (resultCode ***REMOVED***= '000.200.000') {
        ...
        } else if (resultCode ***REMOVED***= '800.900.300') {
  ...
  if (checkoutIdMatch) {
    ...
    console.log('📋 Match:', checkoutId ***REMOVED***= extractedCheckoutId ? '✅' : '❌');
  } else {
