...
router.post('/webhook/test', async (req, res) => {
  console.log('🧪 ***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***= WEBHOOK TEST ENDPOINT ***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***=');
...
router.post('/webhook/afs-debug', async (req, res) => {
  console.log('🔔 ***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***= AFS WEBHOOK DEBUG ***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***=');
  console.log('📅 Timestamp:', new Date().toISOString());
...
router.post('/webhook/manual-trigger', async (req, res) => {
  console.log('🔧 ***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***= MANUAL WEBHOOK TRIGGER ***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***=');
