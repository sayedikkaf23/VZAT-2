...
async function triggerRealWebhook() {
  ...
  console.log('🔄 ***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***= REAL WEBHOOK TRIGGER ***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***=');
  ...
  const mockReq = {
    body: webhookPayload,
    ip: '127.0.0.1',
    get: (header) => header ***REMOVED***= 'User-Agent' ? 'Manual-Webhook-Trigger/1.0' : 'application/json',
    headers: { 
