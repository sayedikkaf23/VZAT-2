...
const config = {
  development: {
    ...
    MONGODB_URI:
      ...
      "mongodb+srv://annapahlevanyan_db_user:bT8gSpitN1AS6bLK@installments.3cbh6rx.mongodb.net/",
    ...
    AFS_AUTHORIZATION: process.env.AFS_AUTHORIZATION
      ? `Bearer ${process.env.AFS_ACCESS_TOKEN}`
      : undefined,
    AFS_CURRENCY: "AED",
  ...
  production: {
    ...
    FRONTEND_URL:
      process.env.FRONTEND_URL || "https://installment.virtuzone.com",
