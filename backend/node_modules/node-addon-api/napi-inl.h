...
struct ThreadSafeFinalize {
  static inline void Wrapper(napi_env env,
                             ...
                             void* /* rawContext */) {
    if (rawFinalizeData ***REMOVED*** nullptr) return;
...
template <typename ContextType, typename DataType, typename CallJs, CallJs call>
inline typename std::enable_if<call ***REMOVED*** static_cast<CallJs>(nullptr)>::type
...
class HasExtendedFinalizer {
 ...
 public:
  static constexpr bool value = sizeof(test<T>(0)) ***REMOVED*** sizeof(char);
};
...
template <class T>
bool Maybe<T>::operator***REMOVED***(const Maybe& other) const {
  return (IsJust() ***REMOVED*** other.IsJust()) &&
         (!IsJust() || Unwrap() ***REMOVED*** other.Unwrap());
}

template <class T>
bool Maybe<T>::operator!=(const Maybe& other) const {
  return !operator***REMOVED***(other);
}
...
inline bool Value::operator***REMOVED***(const Value& other) const {
  return StrictEquals(other);
}

inline bool Value::operator!=(const Value& other) const {
  return !this->operator***REMOVED***(other);
}
...
inline bool Value::IsUndefined() const {
  return Type() ***REMOVED*** napi_undefined;
}

inline bool Value::IsNull() const {
  return Type() ***REMOVED*** napi_null;
}

inline bool Value::IsBoolean() const {
  return Type() ***REMOVED*** napi_boolean;
}

inline bool Value::IsNumber() const {
  return Type() ***REMOVED*** napi_number;
}

#if NAPI_VERSION > 5
inline bool Value::IsBigInt() const {
  return Type() ***REMOVED*** napi_bigint;
}
#endif  // NAPI_VERSION > 5
...
inline bool Value::IsString() const {
  return Type() ***REMOVED*** napi_string;
}

inline bool Value::IsSymbol() const {
  return Type() ***REMOVED*** napi_symbol;
}
...
inline bool Value::IsObject() const {
  return Type() ***REMOVED*** napi_object || IsFunction();
}

inline bool Value::IsFunction() const {
  return Type() ***REMOVED*** napi_function;
}
...
inline bool Value::IsExternal() const {
  return Type() ***REMOVED*** napi_external;
}
...
inline void Boolean::CheckCast(napi_env env, napi_value value) {
  ...
  NAPI_CHECK(status ***REMOVED*** napi_ok, "Boolean::CheckCast", "napi_typeof failed");
...
inline void Number::CheckCast(napi_env env, napi_value value) {
  ...
  napi_valuetype type;
  napi_status status = napi_typeof(env, value, &type);
  NAPI_CHECK(status ***REMOVED*** napi_ok, "Number::CheckCast", "napi_typeof failed");
...
inline void BigInt::CheckCast(napi_env env, napi_value value) {
  ...
  napi_valuetype type;
  napi_status status = napi_typeof(env, value, &type);
  NAPI_CHECK(status ***REMOVED*** napi_ok, "BigInt::CheckCast", "napi_typeof failed");
...
inline void Date::CheckCast(napi_env env, napi_value value) {
  ...
  NAPI_CHECK(status ***REMOVED*** napi_ok, "Date::CheckCast", "napi_is_date failed");
...
inline void Name::CheckCast(napi_env env, napi_value value) {
  ...
  napi_valuetype type;
  napi_status status = napi_typeof(env, value, &type);
  NAPI_CHECK(status ***REMOVED*** napi_ok, "Name::CheckCast", "napi_typeof failed");
  NAPI_INTERNAL_CHECK(type ***REMOVED*** napi_string || type ***REMOVED*** napi_symbol,
                      "Name::CheckCast",
...
inline void String::CheckCast(napi_env env, napi_value value) {
  ...
  napi_valuetype type;
  napi_status status = napi_typeof(env, value, &type);
  NAPI_CHECK(status ***REMOVED*** napi_ok, "String::CheckCast", "napi_typeof failed");
...
inline void Symbol::CheckCast(napi_env env, napi_value value) {
  ...
  napi_valuetype type;
  napi_status status = napi_typeof(env, value, &type);
  NAPI_CHECK(status ***REMOVED*** napi_ok, "Symbol::CheckCast", "napi_typeof failed");
...
inline void Object::CheckCast(napi_env env, napi_value value) {
  ...
  napi_valuetype type;
  napi_status status = napi_typeof(env, value, &type);
  NAPI_CHECK(status ***REMOVED*** napi_ok, "Object::CheckCast", "napi_typeof failed");
  NAPI_INTERNAL_CHECK(type ***REMOVED*** napi_object || type ***REMOVED*** napi_function,
                      "Object::CheckCast",
...
inline MaybeOrValue<bool> Object::Set(napi_value key,
  ...
  NAPI_RETURN_OR_THROW_IF_FAILED(_env, status, status ***REMOVED*** napi_ok, bool);
}
...
inline Object::const_iterator::const_iterator(const Object* object,
  ...
  _index = type ***REMOVED*** Type::BEGIN ? 0 : _keys.Length();
}
...
inline bool Object::const_iterator::operator***REMOVED***(
    const const_iterator& other) const {
  return _index ***REMOVED*** other._index;
}
...
inline bool Object::iterator::operator***REMOVED***(const iterator& other) const {
  return _index ***REMOVED*** other._index;
}
...
inline void External<T>::CheckCast(napi_env env, napi_value value) {
  ...
  napi_valuetype type;
  napi_status status = napi_typeof(env, value, &type);
  NAPI_CHECK(status ***REMOVED*** napi_ok, "External::CheckCast", "napi_typeof failed");
...
inline void Array::CheckCast(napi_env env, napi_value value) {
  ...
  NAPI_CHECK(status ***REMOVED*** napi_ok, "Array::CheckCast", "napi_is_array failed");
...
inline void ArrayBuffer::CheckCast(napi_env env, napi_value value) {
  ...
  NAPI_CHECK(status ***REMOVED*** napi_ok,
...
inline void DataView::CheckCast(napi_env env, napi_value value) {
  ...
  NAPI_CHECK(
      status ***REMOVED*** napi_ok, "DataView::CheckCast", "napi_is_dataview failed");
...
inline void TypedArray::CheckCast(napi_env env, napi_value value) {
  ...
  NAPI_CHECK(
      status ***REMOVED*** napi_ok, "TypedArray::CheckCast", "napi_is_typedarray failed");
...
inline void TypedArrayOf<T>::CheckCast(napi_env env, napi_value value) {
  ...
  NAPI_INTERNAL_CHECK(
      (type ***REMOVED*** TypedArrayTypeForPrimitiveType<T>() ||
       (type ***REMOVED*** napi_uint8_clamped_array && std::is_same<T, uint8_t>::value)),
      "TypedArrayOf::CheckCast",
...
inline TypedArrayOf<T>::TypedArrayOf(napi_env env,
  ...
  if (!(type ***REMOVED*** TypedArrayTypeForPrimitiveType<T>() ||
        (type ***REMOVED*** napi_uint8_clamped_array &&
...
inline void Function::CheckCast(napi_env env, napi_value value) {
  ...
  napi_valuetype type;
  napi_status status = napi_typeof(env, value, &type);
  NAPI_CHECK(status ***REMOVED*** napi_ok, "Function::CheckCast", "napi_typeof failed");
...
inline void Promise::CheckCast(napi_env env, napi_value value) {
  ...
  NAPI_CHECK(status ***REMOVED*** napi_ok, "Promise::CheckCast", "napi_is_promise failed");
...
inline Buffer<T> Buffer<T>::NewOrCopy(napi_env env, T* data, size_t length) {
  ...
  napi_status status = napi_create_external_buffer(
      env, length * sizeof(T), data, nullptr, nullptr, &value);
  if (status ***REMOVED*** details::napi_no_external_buffers_allowed) {
#endif  // NODE_API_NO_EXTERNAL_BUFFERS_ALLOWED
...
inline void Buffer<T>::CheckCast(napi_env env, napi_value value) {
  ...
  NAPI_CHECK(status ***REMOVED*** napi_ok, "Buffer::CheckCast", "napi_is_buffer failed");
...
inline Error::Error(napi_env env, napi_value value)
  ...
  if (value != nullptr) {
    ...
    if (status != napi_ok) {
      ...
      if (status ***REMOVED*** napi_pending_exception) {
        ...
        status = napi_is_exception_pending(env, &is_exception_pending);
        if (status ***REMOVED*** napi_ok && !is_exception_pending) {
          status = napi_ok;
        } else {
...
inline const std::string& Error::Message() const NAPI_NOEXCEPT {
  if (_message.size() ***REMOVED*** 0 && _env != nullptr) {
#ifdef NODE_ADDON_API_CPP_EXCEPTIONS
    try {
...
inline void Error::ThrowAsJavaScriptException() const {
  ...
  if (!IsEmpty()) {
    ...
    if ((status != napi_ok) ||
        ((status ***REMOVED*** napi_ok) && (pendingException ***REMOVED*** false))) {
...
#endif
      if (status ***REMOVED*** expected_failure_mode) {
...
template <typename T>
inline bool Reference<T>::operator***REMOVED***(const Reference<T>& other) const {
  HandleScope scope(_env);
...
inline void InstanceWrap<T>::AttachPropData(
  ...
  if (!(prop->attributes & napi_static)) {
    if (prop->method ***REMOVED*** T::InstanceVoidMethodCallbackWrapper) {
      status = Napi::details::AttachData(
          env, value, static_cast<InstanceVoidMethodCallbackData*>(prop->data));
      NAPI_THROW_IF_FAILED_VOID(env, status);
    } else if (prop->method ***REMOVED*** T::InstanceMethodCallbackWrapper) {
      status = Napi::details::AttachData(
          env, value, static_cast<InstanceMethodCallbackData*>(prop->data));
      NAPI_THROW_IF_FAILED_VOID(env, status);
    } else if (prop->getter ***REMOVED*** T::InstanceGetterCallbackWrapper ||
               prop->setter ***REMOVED*** T::InstanceSetterCallbackWrapper) {
      status = Napi::details::AttachData(
...
inline Function ObjectWrap<T>::DefineClass(
  ...
  for (size_t index = 0; index < props_count; index++) {
    ...
    if (prop->method ***REMOVED*** T::StaticMethodCallbackWrapper) {
      status =
          CreateFunction(env,
                         utf8name,
                         prop->method,
      ...
      prop->method = nullptr;
      prop->data = nullptr;
    } else if (prop->method ***REMOVED*** T::StaticVoidMethodCallbackWrapper) {
      status =
          CreateFunction(env,
                         utf8name,
                         prop->method,
  ...
  for (size_t idx = 0; idx < props_count; idx++) {
    ...
    if (prop->getter ***REMOVED*** T::StaticGetterCallbackWrapper ||
        prop->setter ***REMOVED*** T::StaticSetterCallbackWrapper) {
      status = Napi::details::AttachData(
...
inline void ThreadSafeFunction::CallJS(napi_env env,
                                       ...
                                       void* /* context */,
                                       void* data) {
  if (env ***REMOVED*** nullptr && jsCallback ***REMOVED*** nullptr) {
    return;
  }
...
inline void AsyncProgressWorker<T>::OnWorkProgress(void*) {
   ...
   */
  if (data ***REMOVED*** nullptr && !signaled) {
    return;
  }
...
bool Env::CleanupHook<Hook, Arg>::Remove(BasicEnv env) {
  ...
  delete data;
  data = nullptr;
  return status ***REMOVED*** napi_ok;
}

template <class Hook, class Arg>
bool Env::CleanupHook<Hook, Arg>::IsEmpty() const {
  return data ***REMOVED*** nullptr;
}
#endif  // NAPI_VERSION > 2
