...
function main (args) {
  ...
  const binary = process.platform ***REMOVED***= 'win32'
  ...
  if (
    clangFormatOutput !***REMOVED*** '' &&
    clangFormatOutput !***REMOVED*** 'no modified files to format' &&
    clangFormatOutput !***REMOVED*** 'clang-format did not modify any files'
  ) {
