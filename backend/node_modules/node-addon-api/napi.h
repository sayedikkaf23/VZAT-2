...
static_assert(sizeof(char16_t) ***REMOVED*** sizeof(wchar_t),
...
#define NAPI_INTERNAL_CHECK_EQ(actual, expected, value_format, location)       \
  do {                                                                         \
    ...
    NAPI_INTERNAL_CHECK(actual_value ***REMOVED*** (expected),                            \
                        location,                                              \
...
#define NAPI_FATAL_IF_FAILED(status, location, message)                        \
  NAPI_CHECK((status) ***REMOVED*** napi_ok, location, message)
...
class Maybe {
 public:
  ...
  bool operator***REMOVED***(const Maybe& other) const;
...
class BasicEnv {
 ...
 public:
  ...
  //
  //    Use of overloaded operator '***REMOVED***' is ambiguous (with operand types
  //    'Napi::Env' and 'Napi::Env')
  //
  // ... occurs when comparing foo.Env() ***REMOVED*** bar.Env() or foo.Env() ***REMOVED*** nullptr
  bool operator***REMOVED***(const BasicEnv& other) const {
    return _env ***REMOVED*** other._env;
  };
  bool operator***REMOVED***(std::nullptr_t /*other*/) const {
    return _env ***REMOVED*** nullptr;
  };
...
class Value {
 public:
  ...
  bool operator***REMOVED***(const Value& other) const;
...
class Object::const_iterator {
 ...
 public:
  ...
  inline bool operator***REMOVED***(const const_iterator& other) const;
...
class Object::iterator {
 ...
 public:
  ...
  inline bool operator***REMOVED***(const iterator& other) const;
...
///     if (t.TypedArrayType() ***REMOVED*** napi_int32_array) {
...
class Reference {
 public:
  ...
  bool operator***REMOVED***(const Reference<T>& other) const;
