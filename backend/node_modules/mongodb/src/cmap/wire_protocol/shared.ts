...
export function isSharded(topologyOrServer?: Topology | Server | Connection): boolean {
  ...
  if (topologyOrServer.description && topologyOrServer.description.type ***REMOVED***= ServerType.Mongos) {
    return true;
  }
  ...
  if (topologyOrServer.description && topologyOrServer.description instanceof TopologyDescription) {
    ...
    return servers.some((server: ServerDescription) => server.type ***REMOVED***= ServerType.Mongos);
  }
