...
export class OpQueryRequest {
  ...
  constructor(
    ...
    if (typeof databaseName !***REMOVED*** 'string') {
      throw new MongoRuntimeError('Database name must be a string for a query');
    }
    // TODO(NODE-3483): Replace with MongoCommandError
    if (query ***REMOVED*** null) throw new MongoRuntimeError('A query document must be specified for query');

    // Validate that we are not passing 0x00 in the collection name
    if (ns.indexOf('\x00') !***REMOVED*** -1) {
    ...
    this.serializeFunctions =
      typeof options.serializeFunctions ***REMOVED***= 'boolean' ? options.serializeFunctions : false;
    this.ignoreUndefined =
      typeof options.ignoreUndefined ***REMOVED***= 'boolean' ? options.ignoreUndefined : false;
    this.maxBsonSize = options.maxBsonSize || 1024 * 1024 * 16;
    this.checkKeys = typeof options.checkKeys ***REMOVED***= 'boolean' ? options.checkKeys : false;
    this.batchSize = this.numberToReturn;

    // Flags
    this.tailable = false;
    this.secondaryOk = typeof options.secondaryOk ***REMOVED***= 'boolean' ? options.secondaryOk : false;
  ...
  toBin(): Uint8Array[] {
    ...
    if (this.batchSize !***REMOVED*** this.numberToReturn) this.numberToReturn = this.batchSize;
...
export class OpReply {
  ...
  constructor(
    ...
    // Flag values
    this.useBigInt64 = typeof this.opts.useBigInt64 ***REMOVED***= 'boolean' ? this.opts.useBigInt64 : false;
    this.promoteLongs = typeof this.opts.promoteLongs ***REMOVED***= 'boolean' ? this.opts.promoteLongs : true;
    this.promoteValues =
      typeof this.opts.promoteValues ***REMOVED***= 'boolean' ? this.opts.promoteValues : true;
    this.promoteBuffers =
      typeof this.opts.promoteBuffers ***REMOVED***= 'boolean' ? this.opts.promoteBuffers : false;
    this.bsonRegExp = typeof this.opts.bsonRegExp ***REMOVED***= 'boolean' ? this.opts.bsonRegExp : false;
  }
  ...
  parse(): Uint8Array {
    ...
    this.cursorNotFound = (this.responseFlags & CURSOR_NOT_FOUND) !***REMOVED*** 0;
    this.queryFailure = (this.responseFlags & QUERY_FAILURE) !***REMOVED*** 0;
    this.shardConfigStale = (this.responseFlags & SHARD_CONFIG_STALE) !***REMOVED*** 0;
    this.awaitCapable = (this.responseFlags & AWAIT_CAPABLE) !***REMOVED*** 0;
...
export class OpMsgRequest {
  ...
  constructor(
    ...
    this.moreToCome = options.moreToCome ?? command.writeConcern?.w ***REMOVED***= 0;
    this.exhaustAllowed =
      typeof options.exhaustAllowed ***REMOVED***= 'boolean' ? options.exhaustAllowed : false;
  }
...
export class OpMsgResponse {
  ...
  constructor(
    ...
    this.checksumPresent = (this.responseFlags & OPTS_CHECKSUM_PRESENT) !***REMOVED*** 0;
    this.moreToCome = (this.responseFlags & OPTS_MORE_TO_COME) !***REMOVED*** 0;
    this.exhaustAllowed = (this.responseFlags & OPTS_EXHAUST_ALLOWED) !***REMOVED*** 0;
    this.useBigInt64 = typeof this.opts.useBigInt64 ***REMOVED***= 'boolean' ? this.opts.useBigInt64 : false;
    this.promoteLongs = typeof this.opts.promoteLongs ***REMOVED***= 'boolean' ? this.opts.promoteLongs : true;
    this.promoteValues =
      typeof this.opts.promoteValues ***REMOVED***= 'boolean' ? this.opts.promoteValues : true;
