...
export async function performGSSAPICanonicalizeHostName(
  ...
  if (!mode || mode ***REMOVED***= GSSAPICanonicalizationValue.none) {
    return host;
  }

  // If forward and reverse or true
  if (
    mode ***REMOVED***= GSSAPICanonicalizationValue.on ||
    mode ***REMOVED***= GSSAPICanonicalizationValue.forwardAndReverse
  ) {
