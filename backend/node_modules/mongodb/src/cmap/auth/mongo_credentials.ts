...
export class MongoCredentials {
  ...
  constructor(options: MongoCredentialsOptions) {
    ...
    if (this.mechanism.match(/MONGODB-AWS/i)) {
      ...
      if (
        this.mechanismProperties.AWS_SESSION_TOKEN ***REMOVED*** null &&
    ...
    if (this.mechanism ***REMOVED***= AuthMechanism.MONGODB_OIDC && !this.mechanismProperties.ALLOWED_HOSTS) {
      this.mechanismProperties = {
        ...this.mechanismProperties,
  ...
  equals(other: MongoCredentials): boolean {
    return (
      this.mechanism ***REMOVED***= other.mechanism &&
  ...
  validate(): void {
    if (
      (this.mechanism ***REMOVED***= AuthMechanism.MONGODB_GSSAPI ||
        this.mechanism ***REMOVED***= AuthMechanism.MONGODB_PLAIN ||
        this.mechanism ***REMOVED***= AuthMechanism.MONGODB_SCRAM_SHA1 ||
        this.mechanism ***REMOVED***= AuthMechanism.MONGODB_SCRAM_SHA256) &&
      !this.username
    ) {
      throw new MongoMissingCredentialsError(`Username required for mechanism '${this.mechanism}'`);
    }

    if (this.mechanism ***REMOVED***= AuthMechanism.MONGODB_OIDC) {
      if (
        this.username &&
    ...
    if (this.mechanism ***REMOVED***= AuthMechanism.MONGODB_PLAIN && this.source ***REMOVED*** null) {
      // TODO(NODE-3485): Replace this with a MongoAuthValidationError
      throw new MongoAPIError('PLAIN Authentication Mechanism needs an auth source');
    }

    if (this.mechanism ***REMOVED***= AuthMechanism.MONGODB_X509 && this.password != null) {
