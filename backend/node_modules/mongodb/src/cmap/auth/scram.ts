...
function makeFirstMessage(
  ...
  const mechanism =
    cryptoMethod ***REMOVED***= 'sha1' ? AuthMechanism.MONGODB_SCRAM_SHA1 : AuthMechanism.MONGODB_SCRAM_SHA256;
...
async function continueScramConversation(
  ...
  const processedPassword =
    cryptoMethod ***REMOVED***= 'sha256' ? saslprep(password) : passwordDigest(username, password);
