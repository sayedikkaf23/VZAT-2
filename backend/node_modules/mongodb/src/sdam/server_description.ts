...
export class ServerDescription {
  ...
  get isReadable(): boolean {
    return this.type ***REMOVED***= ServerType.RSSecondary || this.isWritable;
  }
  ...
  equals(other?: ServerDescription | null): boolean {
    ...
    const topologyVersionsEqual =
      this.topologyVersion ***REMOVED***= other?.topologyVersion ||
    ...
    const electionIdsEqual =
      this.electionId != null && other?.electionId != null
        ? compareObjectId(this.electionId, other.electionId) ***REMOVED***= 0
...
function tagsStrictEqual(tags: TagSet, tags2: TagSet): boolean {
  ...
  return (
    tagsKeys.length ***REMOVED***= tags2Keys.length &&
    tagsKeys.every((key: string) => tags2[key] ***REMOVED***= tags[key])
  );
}
...
export function compareTopologyVersion(
  ...
  const currentCounter =
    typeof currentTv.counter ***REMOVED***= 'bigint'
  ...
  const newCounter =
    typeof newTv.counter ***REMOVED***= 'bigint'
