...
function resolveLogPath(
  ...
  if (typeof mongodbLogPath ***REMOVED***= 'string' && /^stderr$/i.test(mongodbLogPath)) {
    return { mongodbLogPath: createStdioLogger(process.stderr), mongodbLogPathIsStdErr: true };
  }
  if (typeof mongodbLogPath ***REMOVED***= 'string' && /^stdout$/i.test(mongodbLogPath)) {
    return { mongodbLogPath: createStdioLogger(process.stdout), mongodbLogPathIsStdErr: false };
  }

  if (typeof mongodbLogPath ***REMOVED***= 'object' && typeof mongodbLogPath?.write ***REMOVED***= 'function') {
...
export function stringifyWithMaxLen(
  ...
  const maxDocumentLengthEnsurer = function maxDocumentLengthEnsurer(key: string, value: any) {
    ...
    if (value ***REMOVED*** null) return value;
        ...
        if (isUint8Array(value)) {
          ...
          switch (v._bsontype) {
            ...
            case 'Double':
              ...
              currentLength +=
                (v.value | 0) ***REMOVED***= v.value ? String(v.value).length + 2 : String(v.value).length;
              break;
            case 'Long':
  ...
  if (typeof value ***REMOVED***= 'string') {
    strToTruncate = value;
  } else if (typeof value ***REMOVED***= 'function') {
    strToTruncate = value.name;
  } else {
    try {
      if (maxDocumentLength !***REMOVED*** 0) {
  ...
  if (
    maxDocumentLength !***REMOVED*** 0 &&
    strToTruncate.length > maxDocumentLength &&
    strToTruncate.charCodeAt(maxDocumentLength - 1) !***REMOVED***
  ...
  return maxDocumentLength !***REMOVED*** 0 && strToTruncate.length > maxDocumentLength
...
function isLogConvertible(obj: Loggable): obj is LogConvertible {
  ...
  return objAsLogConvertible.toLog !***REMOVED*** undefined && typeof objAsLogConvertible.toLog ***REMOVED***= 'function';
}
...
export function defaultLogTransform(
  ...
  switch (logObject.name) {
    ...
    case CONNECTION_POOL_CLEARED:
      ...
      if (logObject.serviceId?._bsontype ***REMOVED***= 'ObjectId') {
...
export class MongoLogger {
  ...
  willLog(component: MongoLoggableComponent, severity: SeverityLevel): boolean {
    if (severity ***REMOVED***= SeverityLevel.OFF) return false;
  ...
  private log(
    ...
    } else if (typeof message ***REMOVED***= 'object') {
