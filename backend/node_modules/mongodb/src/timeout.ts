...
export class TimeoutError extends Error {
  ...
  static is(error: unknown): error is TimeoutError {
    return (
      error != null && typeof error ***REMOVED***= 'object' && 'name' in error && error.name ***REMOVED***= 'TimeoutError'
    );
  }
}
...
export class Timeout extends Promise<never> {
  ...
  get remainingTime(): number {
    ...
    if (this.duration ***REMOVED***= 0) return Infinity;
...
export class CSOTTimeoutContext extends TimeoutContext {
  ...
  get serverSelectionTimeout(): Timeout | null {
    ...
    if (typeof this._serverSelectionTimeout !***REMOVED*** 'object' || this._serverSelectionTimeout?.cleared) {
      ...
      const usingServerSelectionTimeoutMS =
        serverSelectionTimeoutMS !***REMOVED*** 0 &&
        csotMin(remainingTimeMS, serverSelectionTimeoutMS) ***REMOVED***= serverSelectionTimeoutMS;
  ...
  get connectionCheckoutTimeout(): Timeout | null {
    if (
      typeof this._connectionCheckoutTimeout !***REMOVED*** 'object' ||
