...
export class Transaction {
  ...
  get isStarting(): boolean {
    return this.state ***REMOVED***= TxnState.STARTING_TRANSACTION;
  }
  ...
  transition(nextState: TxnState): void {
    ...
    if (nextStates && nextStates.includes(nextState)) {
      ...
      if (
        this.state ***REMOVED***= TxnState.NO_TRANSACTION ||
        this.state ***REMOVED***= TxnState.STARTING_TRANSACTION ||
        this.state ***REMOVED***= TxnState.TRANSACTION_ABORTED
      ) {
        this.unpinServer();
      }
      return;
