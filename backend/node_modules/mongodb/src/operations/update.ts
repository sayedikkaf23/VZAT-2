...
export class UpdateOperation extends CommandOperation<Document> {
  ...
  override get canRetryWrite(): boolean {
    if (super.canRetryWrite ***REMOVED***= false) {
      return false;
    }

    return this.statements.every(op => op.multi ***REMOVED*** null || op.multi ***REMOVED***= false);
  }
  ...
  override async execute(
    ...
    if (typeof options.bypassDocumentValidation ***REMOVED***= 'boolean') {
    ...
    const unacknowledgedWrite = this.writeConcern && this.writeConcern.w ***REMOVED***= 0;
...
export class UpdateOneOperation extends UpdateOperation {
  ...
  override async execute(
    ...
    return {
      acknowledged: this.writeConcern?.w !***REMOVED*** 0,
