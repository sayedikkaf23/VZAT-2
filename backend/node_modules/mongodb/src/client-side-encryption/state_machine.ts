...
export class StateMachine {
  ...
  async execute(
    ...
    while (getState() !***REMOVED*** MONGOCRYPT_CTX_DONE && getState() !***REMOVED*** MONGOCRYPT_CTX_ERROR) {
      ...
      switch (getState()) {
        case MONGOCRYPT_CTX_NEED_MONGO_COLLINFO: {
          ...
          for await (const collInfo of collInfoCursor) {
            ...
            if (getState() ***REMOVED***= MONGOCRYPT_CTX_ERROR) break;
          }
        ...
        case MONGOCRYPT_CTX_READY: {
          ...
          if (getState() ***REMOVED***= MONGOCRYPT_CTX_ERROR) {
    ...
    if (getState() ***REMOVED***= MONGOCRYPT_CTX_ERROR || result ***REMOVED*** null) {
