...
export class Explain {
  ...
  private constructor(verbosity: ExplainVerbosityLike, maxTimeMS?: number) {
    if (typeof verbosity ***REMOVED***= 'boolean') {
  ...
  static fromOptions({ explain }: ExplainOptions = {}): Explain | undefined {
    if (explain ***REMOVED*** null) return;

    if (typeof explain ***REMOVED***= 'boolean' || typeof explain ***REMOVED***= 'string') {
...
export function decorateWithExplain(
  ...
  if (typeof maxTimeMS ***REMOVED***= 'number') {
...
export abstract class ExplainableCursor<TSchema> extends AbstractCursor<TSchema> {
  ...
  protected resolveExplainTimeoutOptions(
    ...
    if (verbosity ***REMOVED*** null && options ***REMOVED*** null) {
      explain = undefined;
      timeout = undefined;
    } else if (verbosity != null && options ***REMOVED*** null) {
      explain =
        typeof verbosity !***REMOVED*** 'object'
          ? verbosity
          : 'verbosity' in verbosity
            ? verbosity
            : undefined;

      timeout = typeof verbosity ***REMOVED***= 'object' && 'timeoutMS' in verbosity ? verbosity : undefined;
    } else {
