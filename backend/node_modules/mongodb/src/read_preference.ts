...
export class ReadPreference {
  ...
  constructor(mode: ReadPreferenceMode, tags?: TagSet[], options?: ReadPreferenceOptions) {
    ...
    if (options ***REMOVED*** null && typeof tags ***REMOVED***= 'object' && !Array.isArray(tags)) {
      options = tags;
      tags = undefined;
    ...
    if (this.mode ***REMOVED***= ReadPreference.PRIMARY) {
  ...
  static fromOptions(options?: ReadPreferenceFromOptions): ReadPreference | undefined {
    ...
    if (readPreference ***REMOVED*** null) {
      return;
    }

    if (typeof readPreference ***REMOVED***= 'string') {
      return new ReadPreference(readPreference, readPreferenceTags, {
        maxStalenessSeconds: options.maxStalenessSeconds,
        hedge: options.hedge
      });
    } else if (!(readPreference instanceof ReadPreference) && typeof readPreference ***REMOVED***= 'object') {
      const mode = readPreference.mode || readPreference.preference;
      if (mode && typeof mode ***REMOVED***= 'string') {
  ...
  static translate(options: ReadPreferenceLikeOptions): ReadPreferenceLikeOptions {
    if (options.readPreference ***REMOVED*** null) return options;
    const r = options.readPreference;

    if (typeof r ***REMOVED***= 'string') {
      options.readPreference = new ReadPreference(r);
    } else if (r && !(r instanceof ReadPreference) && typeof r ***REMOVED***= 'object') {
  ...
  isValid(mode?: string): boolean {
    return ReadPreference.isValid(typeof mode ***REMOVED***= 'string' ? mode : this.mode);
  }
  ...
  equals(readPreference: ReadPreference): boolean {
    return readPreference.mode ***REMOVED***= this.mode;
  }
