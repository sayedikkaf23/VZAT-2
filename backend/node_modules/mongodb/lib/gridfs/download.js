...
function doRead(stream) {
    ...
    const handleReadResult = (doc) => {
        ...
        if (buf.byteLength !***REMOVED*** expectedLength) {
            if (bytesRemaining <= 0) {
        ...
        const atEndOfStream = expectedN ***REMOVED***= stream.s.expectedEnd - 1;
...
function handleEndOption(stream, doc, cursor, options) {
    if (options && options.end != null) {
        ...
        if (options.start ***REMOVED*** null || options.start < 0) {
