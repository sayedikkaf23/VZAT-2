...
class AWSSDKCredentialProvider extends AWSTemporaryCredentialProvider {
    ...
    get provider() {
        ...
        const awsRegionSettingsExist = AWS_REGION.length !***REMOVED*** 0 && AWS_STS_REGIONAL_ENDPOINTS.length !***REMOVED*** 0;
        /**
         ...
         */
        const useRegionalSts = AWS_STS_REGIONAL_ENDPOINTS ***REMOVED***= 'regional' ||
            (AWS_STS_REGIONAL_ENDPOINTS ***REMOVED***= 'legacy' && !LEGACY_REGIONS.has(AWS_REGION));
        this._provider =
