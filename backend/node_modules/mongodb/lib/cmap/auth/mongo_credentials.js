...
class MongoCredentials {
    constructor(options) {
        ...
        if (this.mechanism.match(/MONGODB-AWS/i)) {
            ...
            if (this.mechanismProperties.AWS_SESSION_TOKEN ***REMOVED*** null &&
        ...
        if (this.mechanism ***REMOVED***= providers_1.AuthMechanism.MONGODB_OIDC && !this.mechanismProperties.ALLOWED_HOSTS) {
            this.mechanismProperties = {
                ...this.mechanismProperties,
    ...
    equals(other) {
        return (this.mechanism ***REMOVED***= other.mechanism &&
            this.username ***REMOVED***= other.username &&
            this.password ***REMOVED***= other.password &&
            this.source ***REMOVED***= other.source);
    }
    /**
    ...
    validate() {
        if ((this.mechanism ***REMOVED***= providers_1.AuthMechanism.MONGODB_GSSAPI ||
            this.mechanism ***REMOVED***= providers_1.AuthMechanism.MONGODB_PLAIN ||
            this.mechanism ***REMOVED***= providers_1.AuthMechanism.MONGODB_SCRAM_SHA1 ||
            this.mechanism ***REMOVED***= providers_1.AuthMechanism.MONGODB_SCRAM_SHA256) &&
            !this.username) {
            throw new error_1.MongoMissingCredentialsError(`Username required for mechanism '${this.mechanism}'`);
        }
        if (this.mechanism ***REMOVED***= providers_1.AuthMechanism.MONGODB_OIDC) {
            if (this.username &&
                this.mechanismProperties.ENVIRONMENT &&
                this.mechanismProperties.ENVIRONMENT !***REMOVED*** 'azure') {
            ...
            if ((this.mechanismProperties.ENVIRONMENT ***REMOVED***= 'azure' ||
                this.mechanismProperties.ENVIRONMENT ***REMOVED***= 'gcp') &&
        ...
        if (providers_1.AUTH_MECHS_AUTH_SRC_EXTERNAL.has(this.mechanism)) {
            if (this.source != null && this.source !***REMOVED*** '$external') {
                // TODO(NODE-3485): Replace this with a MongoAuthValidationError
                throw new error_1.MongoAPIError(`Invalid source '${this.source}' for mechanism '${this.mechanism}' specified.`);
            }
        }
        if (this.mechanism ***REMOVED***= providers_1.AuthMechanism.MONGODB_PLAIN && this.source ***REMOVED*** null) {
            // TODO(NODE-3485): Replace this with a MongoAuthValidationError
            throw new error_1.MongoAPIError('PLAIN Authentication Mechanism needs an auth source');
        }
        if (this.mechanism ***REMOVED***= providers_1.AuthMechanism.MONGODB_X509 && this.password != null) {
            if (this.password ***REMOVED***= '') {
