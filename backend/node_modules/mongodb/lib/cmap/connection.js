...
function streamIdentifier(stream, options) {
    ...
    if (typeof remoteAddress ***REMOVED***= 'string' && typeof remotePort ***REMOVED***= 'number') {
...
class Connection extends mongo_types_1.TypedEventEmitter {
    ...
    onTimeout() {
        this.delayedTimeoutId = (0, timers_1.setTimeout)(() => {
            ...
            const beforeHandshake = this.hello ***REMOVED*** null;
    ...
    prepareCommand(db, command, options) {
        ...
        if (this.description.type !***REMOVED*** common_1.ServerType.Standalone) {
            if (!(0, shared_1.isSharded)(this) &&
                !this.description.loadBalanced &&
                this.supportsOpMsg &&
                options.directConnection ***REMOVED***= true &&
                readPreference?.mode ***REMOVED***= 'primary') {
            ...
            else if ((0, shared_1.isSharded)(this) && !this.supportsOpMsg && readPreference?.mode !***REMOVED*** 'primary') {
            ...
            else if (readPreference?.mode !***REMOVED*** 'primary') {
    ...
    async *sendCommand(ns, command, options, responseType) {
        ...
        const bsonOptions = options.documentsReturnedIn ***REMOVED*** null || !options.raw
            ? options
            : {
                ...options,
                raw: false,
            ...
            if (options.timeoutContext?.csotEnabled()) {
                if (responses_1.MongoDBResponse.is(document)) {
                    ...
                    if ((Array.isArray(document?.writeErrors) &&
                        document.writeErrors.some(error => error?.code ***REMOVED***= error_1.MONGODB_ERROR_CODES.MaxTimeMSExpired)) ||
                        document?.writeConcernError?.code ***REMOVED***= error_1.MONGODB_ERROR_CODES.MaxTimeMSExpired) {
                        throw new error_1.MongoOperationTimeoutError('Server reported a timeout error', {
    ...
    async writeCommand(command, options) {
        const finalCommand = options.agreedCompressor ***REMOVED***= 'none' || !commands_1.OpCompressedRequest.canCompress(command)
            ? command
        ...
        try {
            ...
            else if (writeError ***REMOVED***= options.signal?.reason) {
    ...
    async *readMany(options) {
        try {
            ...
            else if (readError ***REMOVED***= options.signal?.reason) {
...
class CryptoConnection extends Connection {
    ...
    async command(ns, cmd, options, responseType) {
        ...
        if (serverWireVersion ***REMOVED***= 0) {
