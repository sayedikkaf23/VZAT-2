...
class ConnectionPool extends mongo_types_1.TypedEventEmitter {
     ...
     */
    get closed() {
        return this.poolState ***REMOVED***= exports.PoolState.closed;
    }
     ...
     */
    ready() {
        if (this.poolState !***REMOVED*** exports.PoolState.paused) {
            return;
        }
    ...
    clear(options = {}) {
        ...
        this.generation += 1;
        const alreadyPaused = this.poolState ***REMOVED***= exports.PoolState.paused;
        this.poolState = exports.PoolState.paused;
    ...
    close() {
        ...
        if (typeof this.connectionCounter.return ***REMOVED***= 'function') {
    ...
    connectionIsStale(connection) {
        ...
        if (this.loadBalanced && serviceId) {
            const sid = serviceId.toHexString();
            const generation = this.serviceGenerations.get(sid);
            return connection.generation !***REMOVED*** generation;
        }
        return connection.generation !***REMOVED*** this.generation;
    }
    ...
    createConnection(callback) {
        ...
        (0, connect_1.connect)(connectOptions).then(connection => {
            ...
            if (this.poolState !***REMOVED*** exports.PoolState.ready) {
                this.pending--;
                connection.destroy();
    ...
    ensureMinPoolSize() {
        ...
        if (this.poolState !***REMOVED*** exports.PoolState.ready || minPoolSize ***REMOVED***= 0) {
            return;
        }
    ...
    processWaitQueue() {
        ...
        while (this.waitQueueSize > 0 &&
            ...
            (maxPoolSize ***REMOVED***= 0 || this.totalConnectionCount < maxPoolSize)) {
