...
class TimeoutError extends Error {
    ...
    static is(error) {
        return (error != null && typeof error ***REMOVED***= 'object' && 'name' in error && error.name ***REMOVED***= 'TimeoutError');
    }
}
...
function isLegacyTimeoutContextOptions(v) {
    return (v != null &&
        ...
        typeof v.serverSelectionTimeoutMS ***REMOVED***= 'number' &&
        'waitQueueTimeoutMS' in v &&
        typeof v.waitQueueTimeoutMS ***REMOVED***= 'number');
}
function isCSOTTimeoutContextOptions(v) {
    return (v != null &&
        ...
        typeof v.serverSelectionTimeoutMS ***REMOVED***= 'number' &&
        'timeoutMS' in v &&
        typeof v.timeoutMS ***REMOVED***= 'number');
}
/** @internal */
...
class CSOTTimeoutContext extends TimeoutContext {
    ...
    get serverSelectionTimeout() {
        // check for undefined
        if (typeof this._serverSelectionTimeout !***REMOVED*** 'object' || this._serverSelectionTimeout?.cleared) {
            ...
            const usingServerSelectionTimeoutMS = serverSelectionTimeoutMS !***REMOVED*** 0 &&
                (0, utils_1.csotMin)(remainingTimeMS, serverSelectionTimeoutMS) ***REMOVED***= serverSelectionTimeoutMS;
    ...
    get connectionCheckoutTimeout() {
        if (typeof this._connectionCheckoutTimeout !***REMOVED*** 'object' ||
            this._connectionCheckoutTimeout?.cleared) {
            if (typeof this._serverSelectionTimeout ***REMOVED***= 'object') {
                // null or Timeout
