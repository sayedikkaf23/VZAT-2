...
function isAggregateError(e) {
    return e != null && typeof e ***REMOVED***= 'object' && 'errors' in e && Array.isArray(e.errors);
}
/**
 * @public
 * @category Error
...
class MongoError extends Error {
    ...
    static buildErrorMessage(e) {
        if (typeof e ***REMOVED***= 'string') {
            return e;
        }
        if (isAggregateError(e) && e.message.length ***REMOVED***= 0) {
            return e.errors.length ***REMOVED***= 0
        ...
        return e != null && typeof e ***REMOVED***= 'object' && 'message' in e && typeof e.message ***REMOVED***= 'string'
            ? e.message
            : 'empty error message';
    }
    get name() {
...
class MongoServerError extends MongoError {
    ...
    constructor(message) {
        ...
        for (const name in message) {
            if (name !***REMOVED*** 'errorLabels' &&
                name !***REMOVED*** 'errmsg' &&
                name !***REMOVED*** 'message' &&
                name !***REMOVED*** 'errorResponse') {
...
function needsRetryableWriteLabel(error, maxWireVersion, serverType) {
    ...
    if (error instanceof MongoWriteConcernError) {
        if (serverType ***REMOVED***= 'Mongos' && maxWireVersion < 9) {
...
function isRetryableReadError(error) {
    const hasRetryableErrorCode = typeof error.code ***REMOVED***= 'number' ? RETRYABLE_READ_ERROR_CODES.has(error.code) : false;
...
function isRecoveringError(err) {
    if (typeof err.code ***REMOVED***= 'number') {
...
function isNodeShuttingDownError(err) {
    return !!(typeof err.code ***REMOVED***= 'number' && SDAM_NODE_SHUTTING_DOWN_ERROR_CODES.has(err.code));
}
/**
...
function isSDAMUnrecoverableError(error) {
    ...
    if (error instanceof MongoParseError || error ***REMOVED*** null) {
        return true;
    }
...
function isResumableError(error, wireVersion) {
    if (error ***REMOVED*** null || !(error instanceof MongoError)) {
        return false;
    }
    if (error instanceof MongoNetworkError) {
        return true;
    ...
    if (wireVersion != null && wireVersion >= 9) {
        ...
        if (error.code ***REMOVED***= exports.MONGODB_ERROR_CODES.CursorNotFound) {
            return true;
        }
        return error.hasErrorLabel(exports.MongoErrorLabel.ResumableChangeStreamError);
    }
    if (typeof error.code ***REMOVED***= 'number') {
