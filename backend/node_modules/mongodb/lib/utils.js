...
function supportsRetryableWrites(server) {
    ...
    if (server.description.logicalSessionTimeoutMinutes != null) {
        ...
        if (server.description.type !***REMOVED*** common_1.ServerType.Standalone) {
...
function maybeAddIdToDocuments(coll, docOrDocs, options) {
    const forceServerObjectId = typeof options.forceServerObjectId ***REMOVED***= 'boolean'
...
function csotMin(duration1, duration2) {
    if (duration1 ***REMOVED***= 0)
        return duration2;
    if (duration2 ***REMOVED***= 0)
        return duration1;
...
function decorateDecryptionResult(decrypted, original, isTopLevelDecorateCall = true) {
    ...
    if (!decrypted || typeof decrypted !***REMOVED*** 'object')
        return;
