...
function isInCloseState(monitor) {
    return monitor.s.state ***REMOVED***= common_1.STATE_CLOSED || monitor.s.state ***REMOVED***= common_1.STATE_CLOSING;
}
/** @public */
...
function useStreamingProtocol(monitor, topologyVersion) {
    ...
    if (topologyVersion ***REMOVED*** null)
        return false;
    const serverMonitoringMode = monitor.options.serverMonitoringMode;
    if (serverMonitoringMode ***REMOVED***= exports.ServerMonitoringMode.poll)
        return false;
    if (serverMonitoringMode ***REMOVED***= exports.ServerMonitoringMode.stream)
        return true;
    ...
    return (callback) => {
        ...
        checkServer(monitor, (err, hello) => {
            if (err) {
                ...
                if (monitor.server.description.type ***REMOVED***= common_1.ServerType.Unknown) {
                    return done();
                }
            }
