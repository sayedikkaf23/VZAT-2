...
class ServerDescription {
    ...
    constructor(address, hello, options = {}) {
        if (address ***REMOVED*** null || address ***REMOVED***= '') {
            throw new error_1.MongoRuntimeError('ServerDescription must be provided with a non-empty address');
        }
        this.address =
            typeof address ***REMOVED***= 'string'
    ...
    get isReadable() {
        return this.type ***REMOVED***= common_1.ServerType.RSSecondary || this.isWritable;
    }
    ...
    equals(other) {
        ...
        const topologyVersionsEqual = this.topologyVersion ***REMOVED***= other?.topologyVersion ||
            compareTopologyVersion(this.topologyVersion, other?.topologyVersion) ***REMOVED***= 0;
        const electionIdsEqual = this.electionId != null && other?.electionId != null
            ? (0, utils_1.compareObjectId)(this.electionId, other.electionId) ***REMOVED***= 0
            : this.electionId ***REMOVED***= other?.electionId;
        return (other != null &&
            other.iscryptd ***REMOVED***= this.iscryptd &&
            (0, utils_1.errorStrictEqual)(this.error, other.error) &&
            this.type ***REMOVED***= other.type &&
            this.minWireVersion ***REMOVED***= other.minWireVersion &&
            (0, utils_1.arrayStrictEqual)(this.hosts, other.hosts) &&
            tagsStrictEqual(this.tags, other.tags) &&
            this.setName ***REMOVED***= other.setName &&
            this.setVersion ***REMOVED***= other.setVersion &&
            electionIdsEqual &&
            this.primary ***REMOVED***= other.primary &&
            this.logicalSessionTimeoutMinutes ***REMOVED***= other.logicalSessionTimeoutMinutes &&
...
function parseServerType(hello, options) {
    ...
    if (hello.msg && hello.msg ***REMOVED***= 'isdbgrid') {
...
function tagsStrictEqual(tags, tags2) {
    ...
    return (tagsKeys.length ***REMOVED***= tags2Keys.length &&
        tagsKeys.every((key) => tags2[key] ***REMOVED***= tags[key]));
}
/**
 ...
 *
 * ```ts
 * currentTv <   newTv ***REMOVED***= -1
 * currentTv ***REMOVED***= newTv ***REMOVED***= 0
 * currentTv >   newTv ***REMOVED***= 1
 * ```
 */
function compareTopologyVersion(currentTv, newTv) {
    if (currentTv ***REMOVED*** null || newTv ***REMOVED*** null) {
        return -1;
    }
