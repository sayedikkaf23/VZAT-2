...
function isIndexDirection(x) {
    return (typeof x ***REMOVED***= 'number' || x ***REMOVED***= '2d' || x ***REMOVED***= '2dsphere' || x ***REMOVED***= 'text' || x ***REMOVED***= 'geoHaystack');
}
function isSingleIndexTuple(t) {
    return Array.isArray(t) && t.length ***REMOVED***= 2 && isIndexDirection(t[1]);
}
/**
...
function resolveIndexDescription(description) {
    ...
    validProvidedOptions.map(([name, value]) => (name ***REMOVED***= 'version' ? ['v', value] : [name, value])));
}
/** @internal */
...
class ListIndexesOperation extends command_1.CommandOperation {
    ...
    async execute(server, session, timeoutContext) {
        ...
        if (serverWireVersion >= 9 && this.options.comment !***REMOVED*** undefined) {
