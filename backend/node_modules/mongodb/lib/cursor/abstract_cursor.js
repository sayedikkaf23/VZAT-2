...
class AbstractCursor extends mongo_types_1.TypedEventEmitter {
    ...
    constructor(client, namespace, options = {}) {
        ...
        if (this.cursorOptions.timeoutMS != null) {
            if (options.timeoutMode ***REMOVED*** null) {
                ...
                if (options.tailable && options.timeoutMode ***REMOVED***= exports.CursorTimeoutMode.LIFETIME) {
        ...
        this.cursorOptions.omitMaxTimeMS =
            this.cursorOptions.timeoutMS != null &&
                ((this.cursorOptions.timeoutMode ***REMOVED***= exports.CursorTimeoutMode.ITERATION &&
    ...
    async hasNext() {
        this.signal?.throwIfAborted();
        if (this.cursorId ***REMOVED***= bson_1.Long.ZERO) {
            return false;
        }
        if (this.cursorOptions.timeoutMode ***REMOVED***= exports.CursorTimeoutMode.ITERATION && this.cursorId != null) {
        ...
        try {
            ...
            if (this.cursorOptions.timeoutMode ***REMOVED***= exports.CursorTimeoutMode.ITERATION) {
    ...
    async fetchBatch() {
        ...
        if (this.cursorId ***REMOVED*** null) {
            ...
            if ((this.documents?.length ?? 0) !***REMOVED*** 0 || this.isDead)
                return;
    ...
    async transformDocument(document) {
        if (this.transform ***REMOVED*** null)
            return document;
        try {
...
class ReadableCursorStream extends stream_1.Readable {
    ...
    _readNext() {
        if (this._cursor.id ***REMOVED***= bson_1.Long.ZERO) {
            this.push(null);
            return;
        }
        this._cursor
...
class CursorTimeoutContext extends timeout_1.TimeoutContext {
    ...
    refresh() {
        if (typeof this.owner !***REMOVED*** 'symbol')
