...
class AutoEncrypter {
    ...
    constructor(client, options) {
        ...
        this[_a] = false;
        this._client = client;
        this._bypassEncryption = options.bypassAutoEncryption ***REMOVED***= true;
        ...
        if (!this._bypassMongocryptdAndCryptShared && !this.cryptSharedLibVersionInfo) {
            ...
            if ((options.extraOptions ***REMOVED*** null || typeof options.extraOptions.mongocryptdURI !***REMOVED*** 'string') &&
