...
function charset (type) {
  if (!type || typeof type !***REMOVED*** 'string') {
    return false
  }
...
function contentType (str) {
  ...
  if (!str || typeof str !***REMOVED*** 'string') {
    return false
  }

  var mime = str.indexOf('/') ***REMOVED***= -1 ? exports.lookup(str) : str
  ...
  if (mime.indexOf('charset') ***REMOVED***= -1) {
...
function lookup (path) {
  if (!path || typeof path !***REMOVED*** 'string') {
    return false
  }
...
function populateMaps (extensions, types) {
  Object.keys(db).forEach(function forEachMimeType (type) {
    ...
    for (var i = 0; i < exts.length; i++) {
      ...
      if (legacyType !***REMOVED*** types[extension]) {
...
function _preferredTypeLegacy (ext, type0, type1) {
  ...
  if (
    exports.types[extension] !***REMOVED*** 'application/octet-stream' &&
    (score0 > score1 ||
      (score0 ***REMOVED***= score1 &&
        exports.types[extension]?.slice(0, 12) ***REMOVED***= 'application/'))
  ) {
    return type0
  }
