...
test('merge()', function (t) {
    ...
    t.test(
        ...
        { skip: typeof Object.defineProperty !***REMOVED*** 'function' },
        function (st) {
            var setCount = 0;
            var getCount = 0;
            var observed = [];
...
test('combine()', function (t) {
    t.test('both arrays', function (st) {
        ...
        st.notEqual(a, combined, 'a !***REMOVED*** combined');
        st.notEqual(b, combined, 'b !***REMOVED*** combined');
    ...
    t.test('one array, one non-array', function (st) {
        ...
        st.notEqual(aN, combinedAnB, 'aN + b !***REMOVED*** aN');
        st.notEqual(a, combinedAnB, 'aN + b !***REMOVED*** a');
        st.notEqual(bN, combinedAnB, 'aN + b !***REMOVED*** bN');
        st.notEqual(b, combinedAnB, 'aN + b !***REMOVED*** b');
        st.deepEqual([1, 2], combinedAnB, 'first argument is array-wrapped when not an array');

        var combinedABn = utils.combine(a, bN);
        st.deepEqual(a, [aN], 'a is not mutated');
        st.notEqual(aN, combinedABn, 'a + bN !***REMOVED*** aN');
        st.notEqual(a, combinedABn, 'a + bN !***REMOVED*** a');
        st.notEqual(bN, combinedABn, 'a + bN !***REMOVED*** bN');
        st.notEqual(b, combinedABn, 'a + bN !***REMOVED*** b');
    ...
    t.test('neither is an array', function (st) {
        ...
        st.notEqual(1, combined, '1 + 2 !***REMOVED*** 1');
        st.notEqual(2, combined, '1 + 2 !***REMOVED*** 2');
