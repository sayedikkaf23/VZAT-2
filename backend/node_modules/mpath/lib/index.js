...
exports.get = function(path, o, special, map) {
  ...
  if ('function' ***REMOVED*** typeof special) {
    if (special.length < 2) {
      map = special;
      special = undefined;
    } else {
  ...
  var parts = 'string' ***REMOVED*** typeof path
    ? stringToParts(path)
    : path;
  ...
  for (var i = 0; i < parts.length; ++i) {
    part = parts[i];
    if (typeof parts[i] !***REMOVED*** 'string' && typeof parts[i] !***REMOVED*** 'number') {
...
exports.has = function(path, o) {
  var parts = typeof path ***REMOVED***= 'string' ?
    stringToParts(path) :
    path;
  ...
  for (var i = 0; i < len; ++i) {
    ...
    if (cur ***REMOVED*** null || typeof cur !***REMOVED*** 'object' || !(parts[i] in cur)) {
      return false;
    }
    cur = cur[parts[i]];
  }
...
exports.unset = function(path, o) {
  ...
  for (var i = 0; i < len; ++i) {
    ...
    if (ignoreProperties.indexOf(parts[i]) !***REMOVED*** -1) {
      return false;
    }
    if (i ***REMOVED***= len - 1) {
      delete cur[parts[i]];
...
exports.set = function(path, val, o, special, map, _copying) {
  ...
  var copy = _copying || (/\$/.test(path) && _copying !***REMOVED*** false),
      obj = o,
      part;
