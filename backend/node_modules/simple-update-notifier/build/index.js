...
function __generator(thisArg, body) {
    ...
    return g = { next: verb(0), "throw": verb(1), "return": verb(2) }, typeof Symbol ***REMOVED***= "function" && (g[Symbol.iterator] = function() { return this; }), g;
    ...
    function step(op) {
        ...
        while (g && (g = 0, op[0] && (_ = 0)), _) try {
            ...
            switch (op[0]) {
                ...
                default:
                    if (!(t = _.trys, t = t.length > 0 && t[t.length - 1]) && (op[0] ***REMOVED***= 6 || op[0] ***REMOVED***= 2)) { _ = 0; continue; }
                    if (op[0] ***REMOVED***= 3 && (!t || (op[1] > t[0] && op[1] < t[3]))) { _.label = op[1]; break; }
                    if (op[0] ***REMOVED***= 6 && _.label < t[1]) { _.label = t[1]; t = op; break; }
...
var hasNewVersion = function (_a) {
    var pkg = _a.pkg, _b = _a.updateCheckInterval, updateCheckInterval = _b ***REMOVED***= void 0 ? 1000 * 60 * 60 * 24 : _b, _c = _a.distTag, distTag = _c ***REMOVED***= void 0 ? 'latest' : _c, alwaysRun = _a.alwaysRun, debug = _a.debug;
