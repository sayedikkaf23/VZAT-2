...
export function serialize(object: Document, options: SerializeOptions = {}): Uint8Array {
  ...
  const ignoreUndefined =
    typeof options.ignoreUndefined ***REMOVED***= 'boolean' ? options.ignoreUndefined : true;
  const minInternalBufferSize =
    typeof options.minInternalBufferSize ***REMOVED***= 'number' ? options.minInternalBufferSize : MAXSIZE;
