...
test('negative zero', function (t) {
    t.equal(inspect(0), '0', 'inspect(0) ***REMOVED***= "0"');
    t.equal(inspect(Object(0)), 'Object(0)', 'inspect(Object(0)) ***REMOVED***= "Object(0)"');
...
test('numericSeparator', function (t) {
    ...
    t.test('3 digit numbers', function (st) {
        ...
        for (var i = -999; i < 1000; i += 1) {
            ...
            if (actual !***REMOVED*** expected || actualSepNo !***REMOVED*** expected || actualSepYes !***REMOVED*** expected) {
                failed = true;
