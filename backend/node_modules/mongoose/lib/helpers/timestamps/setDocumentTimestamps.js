...
module.exports = function setDocumentTimestamps(doc, timestampOption, currentTime, createdAt, updatedAt) {
  const skipUpdatedAt = timestampOption != null && timestampOption.updatedAt ***REMOVED***= false;
  const skipCreatedAt = timestampOption != null && timestampOption.createdAt ***REMOVED***= false;
