...
function compile(tree, proto, prefix, options) {
  ...
  for (const key of Object.keys(tree)) {
    ...
    const hasSubprops = isPOJO(limb) &&
      ...
      (!limb[typeKey] || (typeKey ***REMOVED***= 'type' && isPOJO(limb.type) && limb.type.type));
      ...
      get: function() {
        ...
        if (!this.$__.getters[path]) {
          ...
          Object.defineProperty(nested, '$isEmpty', {
            ...
            writable: false,
            value: function() {
              return Object.keys(this.get(path, null, _isEmptyOptions) || {}).length ***REMOVED***= 0;
            }
          });
