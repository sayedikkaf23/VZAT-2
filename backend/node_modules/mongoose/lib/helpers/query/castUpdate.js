...
module.exports = function castUpdate(schema, obj, options, context, filter) {
  ...
  if (schema != null &&
      ...
      typeof filter[schema.options.discriminatorKey] !***REMOVED*** 'object' &&
  ...
  if (Object.keys(ret).length ***REMOVED***= 0 &&
      options.upsert &&
...
function castPipelineOperator(op, val) {
  if (op ***REMOVED***= '$unset') {
    if (typeof val !***REMOVED*** 'string' && (!Array.isArray(val) || val.find(v => typeof v !***REMOVED*** 'string'))) {
      throw new MongooseError('Invalid $unset in pipeline, must be ' +
        ' a string or an array of strings');
    }
    return val;
  }
  if (op ***REMOVED***= '$project') {
    if (val ***REMOVED*** null || typeof val !***REMOVED*** 'object') {
      throw new MongooseError('Invalid $project in pipeline, must be an object');
    }
    return val;
  }
  if (op ***REMOVED***= '$addFields' || op ***REMOVED***= '$set') {
    if (val ***REMOVED*** null || typeof val !***REMOVED*** 'object') {
      throw new MongooseError('Invalid ' + op + ' in pipeline, must be an object');
    }
    return val;
  } else if (op ***REMOVED***= '$replaceRoot' || op ***REMOVED***= '$replaceWith') {
    if (val ***REMOVED*** null || typeof val !***REMOVED*** 'object') {
      throw new MongooseError('Invalid ' + op + ' in pipeline, must be an object');
    }
    return val;
...
function walkUpdatePath(schema, obj, op, options, context, filter, pref) {
  ...
  while (i--) {
    ...
    if (
      ...
      discriminatorKey ***REMOVED***= schema.options.discriminatorKey &&
      schema.discriminatorMapping.value !***REMOVED*** obj[key] &&
      !options.overwriteDiscriminatorKey
    ) {
      if (strictMode ***REMOVED***= 'throw') {
    ...
    if (getConstructorName(val) ***REMOVED***= 'Object') {
      ...
      if (schematype && schematype.caster && op in castOps) {
        ...
        if ('$each' in val) {
          ...
          if (schematype != null && schematype.$isSingleNested) {
            const _strict = strict ***REMOVED*** null ? schematype.schema.options.strict : strict;
            try {
      ...
      } else if ((op ***REMOVED***= '$currentDate') || (op in castOps && schematype)) {
        ...
        let _strict = strict;
        if (v && v.schema && _strict ***REMOVED*** null) {
          _strict = v.schema.options.strict;
        }

        if (v.pathType ***REMOVED***= 'undefined') {
          if (_strict ***REMOVED***= 'throw') {
        ...
        hasKeys |= walkUpdatePath(schema, val, op, options, context, filter, prefix + key) ||
          (utils.isObject(val) && Object.keys(val).length ***REMOVED***= 0);
      }
    } else {
      const checkPath = (key ***REMOVED***= '$each' || key ***REMOVED***= '$or' || key ***REMOVED***= '$and' || key ***REMOVED***= '$in') ?
        pref : prefix + key;
      ...
      let isStrict = strict;
      if (pathDetails && pathDetails.schema && strict ***REMOVED*** null) {
      ...
      if (skip) {
        ...
        if (isStrict ***REMOVED***= 'throw' && schema.virtuals[checkPath] ***REMOVED*** null) {
          throw new StrictModeError(prefix + key);
        } else {
          delete obj[key];
        }
      } else {
        if (op ***REMOVED***= '$rename') {
          if (obj[key] ***REMOVED*** null) {
        ...
        try {
          if (prefix.length ***REMOVED***= 0 || key.indexOf('.') ***REMOVED***= -1) {
            obj[key] = castUpdateVal(schematype, val, op, key, context, prefix + key);
          } else if (isStrict !***REMOVED*** false || schematype != null) {
        ...
        if (Array.isArray(obj[key]) && (op ***REMOVED***= '$addToSet' || op ***REMOVED***= '$push') && key !***REMOVED*** '$each') {
          if (schematype &&
              schematype.caster &&
...
function _appendError(error, query, key, aggregatedError) {
  if (typeof query !***REMOVED*** 'object' || !query.options.multipleCastError) {
    throw error;
  }
...
function castUpdateVal(schema, val, op, $conditional, context, path) {
  ...
  if (op ***REMOVED***= '$currentDate') {
    if (typeof val ***REMOVED***= 'object') {
