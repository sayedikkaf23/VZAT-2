...
module.exports = function cast$expr(val, schema, strictQuery) {
  if (typeof val ***REMOVED***= 'boolean') {
    return val;
  }
  if (typeof val !***REMOVED*** 'object' || val ***REMOVED***= null) {
...
function _castExpression(val, schema, strictQuery) {
  ...
  if (isPath(val) || val ***REMOVED***= null) {
    return val;
  }
...
function castIn(val, schema, strictQuery) {
  ...
  if (schematype ***REMOVED***= null) {
    if (strictQuery ***REMOVED***= false) {
      return val;
    } else if (strictQuery ***REMOVED***= 'throw') {
...
function castComparison(val, schema, strictQuery) {
  if (!Array.isArray(val) || val.length !***REMOVED*** 2) {
  ...
  if (isLiteral(val[1])) {
    ...
    } else if (typeof lhs ***REMOVED***= 'object' && lhs != null) {
    ...
    const is$literal = typeof val[1] ***REMOVED***= 'object' && val[1] != null && val[1].$literal != null;
    if (schematype != null) {
      if (is$literal) {
    ...
    } else if (path != null && strictQuery ***REMOVED***= true) {
      return void 0;
    } else if (path != null && strictQuery ***REMOVED***= 'throw') {
...
function isPath(val) {
  return typeof val ***REMOVED***= 'string' && val[0] ***REMOVED***= '$';
}

function isLiteral(val) {
  if (typeof val ***REMOVED***= 'string' && val[0] ***REMOVED***= '$') {
    return false;
  }
  if (typeof val ***REMOVED***= 'object' && val !***REMOVED*** null && Object.keys(val).find(key => key[0] ***REMOVED***= '$')) {
