...
function processConnectionOptions(uri, options) {
  ...
  const resolvedOpts = (readPreference && readPreference !***REMOVED*** 'primary' && readPreference !***REMOVED*** 'primaryPreferred')
...
function setsSecondaryRead(prefString) {
  return !!(prefString ***REMOVED***= 'secondary' || prefString ***REMOVED***= 'secondaryPreferred');
}
