...
function assignRawDocsToIdStructure(rawIds, resultDocs, resultOrder, options, recursed) {
  ...
  if (sorting && recursed && options[kHasArray] ***REMOVED***= undefined) {
  ...
  for (i = 0; i < len; ++i) {
    ...
    if (id ***REMOVED***= null && sorting ***REMOVED***= false) {
    ...
    if (id?.constructor?.name ***REMOVED***= 'Binary' && id.sub_type ***REMOVED***= 4 && typeof id.toUUID ***REMOVED***= 'function') {
      // Workaround for gh-15315 because Mongoose UUIDs don't use BSON UUIDs yet.
      sid = String(id.toUUID());
    } else if (id?.constructor?.name ***REMOVED***= 'Buffer' && id._subtype ***REMOVED***= 4 && typeof id.toUUID ***REMOVED***= 'function') {
      sid = String(id.toUUID());
    } else {
      sid = String(id);
    }
