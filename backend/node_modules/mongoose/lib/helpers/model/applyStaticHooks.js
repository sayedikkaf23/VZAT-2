...
module.exports = function applyStaticHooks(model, hooks, statics) {
  ...
  hooks = hooks.filter(hook => {
    ...
    if (middlewareFunctions.indexOf(hook.name) !***REMOVED*** -1) {
      return !!hook.model;
    }
    return hook.model !***REMOVED*** false;
  });
  ...
  for (const key of Object.keys(statics)) {
    if (hooks.hasHooks(key)) {
      ...
      model[key] = function() {
        ...
        const cb = typeof lastArg ***REMOVED***= 'function' ? lastArg : null;
        const args = Array.prototype.slice.
          call(arguments, 0, cb ***REMOVED*** null ? numArgs : numArgs - 1);
