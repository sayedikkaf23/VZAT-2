...
function clone(obj, options, isArrayChild) {
  ...
  if (typeof obj ***REMOVED***= 'number' || typeof obj ***REMOVED***= 'string' || typeof obj ***REMOVED***= 'boolean' || typeof obj ***REMOVED***= 'bigint') {
    return obj;
  }
  ...
  if (isMongooseObject(obj)) {
    ...
    let ret;
    if (options && options.json && typeof obj.toJSON ***REMOVED***= 'function') {
  ...
  if (typeof obj ***REMOVED***= 'object' && obj[symbols.schemaTypeSymbol]) {
    return obj.clone();
  }
  ...
  if (options && options.bson && typeof obj.toBSON ***REMOVED***= 'function') {
    return obj;
  }

  if (typeof obj.valueOf ***REMOVED***= 'function') {
    return obj.valueOf();
  }
...
function cloneObject(obj, options, isArrayChild) {
  ...
  if (trustedSymbol in obj && options?.copyTrustedSymbol !***REMOVED*** false) {
  ...
  for (let i = 0; i < len; ++i) {
    ...
    if ((minimize ***REMOVED***= false || omitUndefined) && typeof val ***REMOVED***= 'undefined') {
      delete ret[key];
    } else if (minimize !***REMOVED*** true || (typeof val !***REMOVED*** 'undefined')) {
...
function cloneRegExp(regexp) {
  ...
  if (ret.lastIndex !***REMOVED*** regexp.lastIndex) {
