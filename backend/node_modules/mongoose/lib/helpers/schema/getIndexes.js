  ...
  function collectIndexes(schema, prefix, baseSchema) {
    ...
    for (const key of keys) {
      ...
      if (path.$isMongooseDocumentArray || path.$isSingleNested) {
        if (get(path, 'options.excludeIndexes') !***REMOVED*** true &&
            get(path, 'schemaOptions.excludeIndexes') !***REMOVED*** true &&
            get(path, 'schema.options.excludeIndexes') !***REMOVED*** true) {
      ...
      if (index !***REMOVED*** false && index !***REMOVED*** null && index !***REMOVED*** undefined) {
        const field = {};
        const isObject = helperIsObject(index);
        const options = isObject ? index : {};
        const type = typeof index ***REMOVED***= 'string' ? index :
          isObject ? index.type :
            false;

        if (type && indexTypes.indexOf(type) !***REMOVED*** -1) {
          ...
          if (index ***REMOVED***= 'descending' || index ***REMOVED***= 'desc') {
            isDescendingIndex = true;
          } else if (index ***REMOVED***= 'ascending' || index ***REMOVED***= 'asc') {
            isDescendingIndex = false;
          } else {
            isDescendingIndex = Number(index) ***REMOVED***= -1;
          }
        ...
        if (typeof indexName ***REMOVED***= 'string') {
