...
function Aggregate(pipeline, modelOrConn) {
  this._pipeline = [];
  if (modelOrConn ***REMOVED*** null || modelOrConn[modelSymbol]) {
  ...
  if (arguments.length ***REMOVED***= 1 && Array.isArray(pipeline)) {
 ...
 *     aggregate.model() ***REMOVED***= MyModel; // true
 *
 *     // Change the model. There's rarely any reason to do this.
 *     aggregate.model(SomeOtherModel);
 *     aggregate.model() ***REMOVED***= SomeOtherModel; // true
 *
...
Aggregate.prototype.model = function(model) {
  ...
  if (model.schema != null) {
    if (this.options.readPreference ***REMOVED*** null &&
      model.schema.options.read != null) {
      this.options.readPreference = model.schema.options.read;
    }
    if (this.options.collation ***REMOVED*** null &&
...
Aggregate.prototype.append = function() {
  const args = (arguments.length ***REMOVED***= 1 && Array.isArray(arguments[0]))
    ? arguments[0]
    : [...arguments];
...
Aggregate.prototype.addFields = function(arg) {
  if (typeof arg !***REMOVED*** 'object' || arg ***REMOVED***= null || Array.isArray(arg)) {
...
Aggregate.prototype.project = function(arg) {
  ...
  } else if (arguments.length ***REMOVED***= 1 && typeof arg ***REMOVED***= 'string') {
    arg.split(/\s+/).forEach(function(field) {
      if (!field) {
        return;
      }
      const include = field[0] ***REMOVED***= '-' ? 0 : 1;
      if (include ***REMOVED***= 0) {
...
Aggregate.prototype.near = function(arg) {
  ...
  if (typeof arg.near ***REMOVED***= 'object' && (!Array.isArray(coordinates) || coordinates.length < 2 || coordinates.find(c => typeof c !***REMOVED*** 'number'))) {
...
Aggregate.prototype.unwind = function() {
  ...
  for (const arg of args) {
    if (arg && typeof arg ***REMOVED***= 'object') {
      res.push({ $unwind: arg });
    } else if (typeof arg ***REMOVED***= 'string') {
      res.push({
        $unwind: (arg[0] ***REMOVED***= '$') ? arg : '$' + arg
      });
    } else {
...
Aggregate.prototype.replaceRoot = function(newRoot) {
  ...
  if (typeof newRoot ***REMOVED***= 'string') {
...
Aggregate.prototype.sortByCount = function(arg) {
  if (arg && typeof arg ***REMOVED***= 'object') {
    ...
    return this.append({
      $sortByCount: (arg[0] ***REMOVED***= '$') ? arg : '$' + arg
    });
  } else {
...
Aggregate.prototype.graphLookup = function(options) {
  ...
  if (options) {
    ...
    if (startWith && typeof startWith ***REMOVED***= 'string') {
...
Aggregate.prototype.sort = function(arg) {
  ...
  if (getConstructorName(arg) ***REMOVED***= 'Object') {
    ...
    Object.keys(arg).forEach(function(field) {
      ...
      sort[field] = desc.indexOf(arg[field]) ***REMOVED***= -1 ? 1 : -1;
    });
  } else if (arguments.length ***REMOVED***= 1 && typeof arg ***REMOVED***= 'string') {
    arg.split(/\s+/).forEach(function(field) {
      if (!field) {
      ...
      const ascend = field[0] ***REMOVED***= '-' ? -1 : 1;
      if (ascend ***REMOVED***= -1) {
        field = field.substring(1);
      }
      sort[field] = ascend;
...
Aggregate.prototype.redact = function(expression, thenExpr, elseExpr) {
  if (arguments.length ***REMOVED***= 3) {
    if ((typeof thenExpr ***REMOVED***= 'string' && !validRedactStringValues.has(thenExpr)) ||
      (typeof elseExpr ***REMOVED***= 'string' && !validRedactStringValues.has(elseExpr))) {
  ...
  } else if (arguments.length !***REMOVED*** 1) {
...
Aggregate.prototype.explain = async function explain(verbosity) {
  if (typeof verbosity ***REMOVED***= 'function' || typeof arguments[1] ***REMOVED***= 'function') {
...
function isOperator(obj) {
  ...
  return k.length ***REMOVED***= 1 && k[0][0] ***REMOVED***= '$';
}
