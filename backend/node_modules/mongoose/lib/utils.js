...
exports.toCollectionName = function(name, pluralize) {
  if (name ***REMOVED***= 'system.profile') {
    return name;
  }
  if (name ***REMOVED***= 'system.indexes') {
    return name;
  }
  if (typeof pluralize ***REMOVED***= 'function') {
    if (typeof name !***REMOVED*** 'string') {
      throw new TypeError('Collection name must be a string');
    }
    if (name.length ***REMOVED***= 0) {
...
exports.deepEqual = function deepEqual(a, b) {
  ...
  if (typeof a !***REMOVED*** 'object' || typeof b !***REMOVED*** 'object') {
    return a ***REMOVED***= b;
  }

  if (a instanceof Date && b instanceof Date) {
    return a.getTime() ***REMOVED***= b.getTime();
  }

  if ((isBsonType(a, 'ObjectId') && isBsonType(b, 'ObjectId')) ||
      (isBsonType(a, 'Decimal128') && isBsonType(b, 'Decimal128'))) {
    return a.toString() ***REMOVED***= b.toString();
  }

  if (a instanceof RegExp && b instanceof RegExp) {
    return a.source ***REMOVED***= b.source &&
        a.ignoreCase ***REMOVED***= b.ignoreCase &&
        a.multiline ***REMOVED***= b.multiline &&
        a.global ***REMOVED***= b.global &&
        a.dotAll ***REMOVED***= b.dotAll &&
        a.unicode ***REMOVED***= b.unicode &&
        a.sticky ***REMOVED***= b.sticky &&
        a.hasIndices ***REMOVED***= b.hasIndices;
  }

  if (a ***REMOVED*** null || b ***REMOVED*** null) {
    return false;
  }

  if (a.prototype !***REMOVED*** b.prototype) {
    return false;
  }
  ...
  if (a instanceof Number && b instanceof Number) {
    return a.valueOf() ***REMOVED***= b.valueOf();
  }
  ...
  // hasOwnProperty)
  if (kaLength !***REMOVED*** kb.length) {
    return false;
  }

  // ~~~cheap key test
  for (let i = kaLength - 1; i >= 0; i--) {
    if (ka[i] !***REMOVED*** kb[i]) {
      return false;
    }
  }
...
exports.isNonBuiltinObject = function isNonBuiltinObject(val) {
  return typeof val ***REMOVED***= 'object' &&
...
exports.isEmptyObject = function(val) {
  return val != null &&
    typeof val ***REMOVED***= 'object' &&
    Object.keys(val).length ***REMOVED***= 0;
};
...
exports.expires = function expires(object) {
  if (!(object && object.constructor.name ***REMOVED***= 'Object')) {
    return;
  }
  ...
  object.expireAfterSeconds = (typeof object.expires !***REMOVED*** 'string')
    ? object.expires
...
exports.populate = function populate(path, select, model, match, options, subPopulate, justOne, count) {
  ...
  } else if (typeof model ***REMOVED***= 'object') {
    obj = {
      path: path,
      select: select,
      match: model,
  ...
  if (typeof obj.path !***REMOVED*** 'string' && !(Array.isArray(obj.path) && obj.path.every(el => typeof el ***REMOVED***= 'string'))) {
...
function _populateObj(obj) {
  ...
  } else if (obj.populate != null && typeof obj.populate ***REMOVED***= 'object') {
...
function getValueLookup(obj, part) {
  if (part ***REMOVED***= '$*' && obj instanceof Map) {
    return obj;
  }
...
exports.isNullOrUndefined = function(val) {
  return val ***REMOVED***= null || val ***REMOVED***= undefined;
};
...
exports.hasUserDefinedProperty = function(obj, key) {
  ...
  if (typeof obj ***REMOVED***= 'object' && key in obj) {
    const v = obj[key];
    return v !***REMOVED*** Object.prototype[key] && v !***REMOVED*** Array.prototype[key];
  }
...
exports.array.unique = function(arr) {
  ...
  for (const item of arr) {
    if (typeof item ***REMOVED***= 'number' || typeof item ***REMOVED***= 'string' || item ***REMOVED*** null) {
...
exports.mergeClone = function(to, fromObj) {
  ...
  while (i < len) {
    ...
    if (typeof to[key] ***REMOVED***= 'undefined') {
...
exports.injectTimestampsOption = function injectTimestampsOption(writeOperation, timestampsOption) {
  if (timestampsOption ***REMOVED*** null) {
    return;
  }
