...
function getValueType(value) {
  ...
  if (typeof value.constructor !***REMOVED*** 'function') {
    return t;
  }
...
function getMessageFormat(schemaType) {
  ...
  if (typeof messageFormat ***REMOVED***= 'string' || typeof messageFormat ***REMOVED***= 'function') {
...
function formatMessage(model, kind, value, path, messageFormat, valueType, reason) {
  if (typeof messageFormat ***REMOVED***= 'string') {
    ...
    return ret;
  } else if (typeof messageFormat ***REMOVED***= 'function') {
    ...
    if (reason != null &&
        typeof reason.constructor ***REMOVED***= 'function' &&
        reason.constructor.name !***REMOVED*** 'AssertionError' &&
        reason.constructor.name !***REMOVED*** 'Error') {
