...
function binaryToString(uuidBin) {
  ...
  let hex;
  if (typeof uuidBin !***REMOVED*** 'string' && uuidBin != null) {
...
function SchemaUUID(key, options) {
  ...
  this.getters.push(function(value) {
    ...
    } else if (utils.isPOJO(value) && value.type ***REMOVED***= 'Buffer' && Array.isArray(value.data)) {
 ...
 *       assert.ok(typeof v ***REMOVED***= "string" && v.length > 0);
 *       return original(v);
 *     });
 *
