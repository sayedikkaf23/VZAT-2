...
SchemaBuffer.prototype.cast = function(value, doc, init, prev, options) {
  ...
  if (SchemaType._isRef(this, value, doc, init)) {
    ...
    if (value instanceof Binary) {
      ...
      if (typeof value.sub_type !***REMOVED*** 'number') {
  ...
  if (
    type ***REMOVED***= 'string' || type ***REMOVED***= 'number' || Array.isArray(value) ||
    (type ***REMOVED***= 'object' && value.type ***REMOVED***= 'Buffer' && Array.isArray(value.data)) // gh-6863
  ) {
  ...
  if (utils.isPOJO(value) && (value.$binary instanceof Binary || typeof value.$binary ***REMOVED***= 'string')) {
