...
SchemaDate.prototype.expires = function(when) {
  if (getConstructorName(this._index) !***REMOVED*** 'Object') {
    this._index = {};
  }
...
SchemaDate.prototype.min = function(value, message) {
  ...
  if (value) {
    ...
    if (typeof msg ***REMOVED***= 'string') {
      msg = msg.replace(/{MIN}/, (value ***REMOVED***= Date.now ? 'Date.now()' : value.toString()));
    }
    const _this = this;
    this.validators.push({
      validator: this.minValidator = function(val) {
        let _value = value;
        if (typeof value ***REMOVED***= 'function' && value !***REMOVED*** Date.now) {
          _value = _value.call(this);
        }
        const min = (_value ***REMOVED***= Date.now ? _value() : _this.cast(_value));
        return val ***REMOVED***= null || val.valueOf() >= min.valueOf();
      },
      message: msg,
      type: 'min',
      min: value
...
SchemaDate.prototype.max = function(value, message) {
  ...
  if (value) {
    ...
    if (typeof msg ***REMOVED***= 'string') {
      msg = msg.replace(/{MAX}/, (value ***REMOVED***= Date.now ? 'Date.now()' : value.toString()));
    }
    const _this = this;
    this.validators.push({
      validator: this.maxValidator = function(val) {
        let _value = value;
        if (typeof _value ***REMOVED***= 'function' && _value !***REMOVED*** Date.now) {
          _value = _value.call(this);
        }
        const max = (_value ***REMOVED***= Date.now ? _value() : _this.cast(_value));
        return val ***REMOVED***= null || val.valueOf() <= max.valueOf();
      },
      message: msg,
      type: 'max',
      max: value
