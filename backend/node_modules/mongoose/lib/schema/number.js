...
SchemaNumber._checkRequired = v => typeof v ***REMOVED***= 'number' || v instanceof Number;
...
SchemaNumber.prototype.min = function(value, message) {
  if (this.minValidator) {
    this.validators = this.validators.filter(function(v) {
      return v.validator !***REMOVED*** this.minValidator;
    }, this);
  }
...
SchemaNumber.prototype.max = function(value, message) {
  if (this.maxValidator) {
    this.validators = this.validators.filter(function(v) {
      return v.validator !***REMOVED*** this.maxValidator;
    }, this);
  }
...
SchemaNumber.prototype.enum = function(values, message) {
  ...
  if (!Array.isArray(values)) {
    ...
    } else if (typeof values ***REMOVED***= 'number') {
  ...
  message = message ***REMOVED*** null ? MongooseError.messages.Number.enum : message;

  this.enumValidator = v => v ***REMOVED*** null || values.indexOf(v) !***REMOVED*** -1;
  this.validators.push({
...
SchemaNumber.prototype.cast = function(value, doc, init, prev, options) {
  if (typeof value !***REMOVED*** 'number' && SchemaType._isRef(this, value, doc, init)) {
    if (value ***REMOVED*** null || utils.isNonBuiltinObject(value)) {
      return this._castRef(value, doc, init, options);
    }
  }

  const val = value && typeof value._id !***REMOVED*** 'undefined' ?
    value._id : // documents
    value;
...
SchemaNumber.prototype.toJSONSchema = function toJSONSchema(options) {
  const isRequired = (this.options.required && typeof this.options.required !***REMOVED*** 'function') || this.path ***REMOVED***= '_id';
