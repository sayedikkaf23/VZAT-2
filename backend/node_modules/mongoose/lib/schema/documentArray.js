...
function _createConstructor(schema, options, baseClass) {
  ...
  function EmbeddedDocument() {
    ...
    if (this.__parentArray ***REMOVED*** null || this.__parentArray.getArrayParent() ***REMOVED*** null) {
      return;
    }
...
SchemaDocumentArray.prototype.doValidateSync = function(array, scope, options) {
  ...
  for (let i = 0, len = count; i < len; ++i) {
    ...
    if (subdocValidateError && resultError ***REMOVED*** null) {
...
SchemaDocumentArray.prototype.getDefault = function(scope, init, options) {
  let ret = typeof this.defaultValue ***REMOVED***= 'function'
...
SchemaDocumentArray.prototype.cast = function(value, doc, init, prev, options) {
  ...
  if (value != null && value[arrayPathSymbol] != null && value ***REMOVED***= prev) {
    return value;
  }
  ...
  for (let i = 0; i < len; ++i) {
    ...
    if (rawArray[i] !***REMOVED*** spreadDoc) {
      rawArray[i] = spreadDoc;
    }

    if (rawArray[i] instanceof Subdocument) {
      if (rawArray[i][documentArrayParent] !***REMOVED*** doc) {
        if (init) {
      ...
      if (rawArray[i].__index ***REMOVED*** null) {
      ...
      if (init) {
        ...
        if (prev && typeof prev.id ***REMOVED***= 'function') {
