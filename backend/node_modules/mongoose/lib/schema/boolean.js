 ...
 * #### Example:
 *
 *     mongoose.Schema.Boolean.get(v => v ***REMOVED***= true ? 'yes' : 'no');
 *
 *     const Order = mongoose.model('Order', new Schema({ isPaid: Boolean }));
...
SchemaBoolean._defaultCaster = v => {
  if (v != null && typeof v !***REMOVED*** 'boolean') {
    throw new Error();
  }
  return v;
};
...
SchemaBoolean._checkRequired = v => v ***REMOVED***= true || v ***REMOVED***= false;
...
SchemaBoolean.prototype._castNullish = function _castNullish(v) {
  if (typeof v ***REMOVED***= 'undefined') {
    return v;
  }
  const castBoolean = typeof this.constructor.cast ***REMOVED***= 'function' ?
    this.constructor.cast() :
    SchemaBoolean.cast();
  if (castBoolean ***REMOVED*** null) {
    return v;
  }
