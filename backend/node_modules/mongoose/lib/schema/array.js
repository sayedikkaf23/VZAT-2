...
function SchemaArray(key, cast, options, schemaOptions) {
  ...
  if (cast) {
    ...
    if (options != null && options.ref != null && castOptions.ref ***REMOVED*** null) {
      castOptions.ref = options.ref;
    }

    if (cast ***REMOVED***= Object) {
      cast = Mixed;
    }

    // support { type: 'String' }
    const name = typeof cast ***REMOVED***= 'string'
      ? cast
    ...
    if (typeof caster ***REMOVED***= 'function' &&
  ...
  if (this.defaultValue != null) {
    ...
    fn = typeof defaultArr ***REMOVED***= 'function';
  }
...
SchemaArray.prototype.enum = function() {
  ...
  while (true) {
    ...
    arr.caster &&
    arr.caster.instance;
    if (instance ***REMOVED***= 'Array') {
      arr = arr.caster;
      continue;
    }
    if (instance !***REMOVED*** 'String' && instance !***REMOVED*** 'Number') {
...
SchemaArray.prototype._applySetters = function(value, scope, init, priorVal) {
  if (this.casterConstructor.$isMongooseArray &&
    ...
    if (value != null && value.length !***REMOVED*** 0) {
      const valueDepth = arrayDepth(value);
      if (valueDepth.min ***REMOVED***= valueDepth.max && valueDepth.max < depth && valueDepth.containsNonArrayItem) {
  ...
  if (Array.isArray(value)) {
    ...
    if (!len && doc) {
      ...
      for (i = 0, l = indexes.length; i < l; ++i) {
        ...
        if (pathIndex ***REMOVED***= '2dsphere' || pathIndex ***REMOVED***= '2d') {
          return;
        }
      }
    ...
    if (caster && this.casterConstructor !***REMOVED*** Mixed) {
      try {
...
SchemaArray.prototype.discriminator = function(...args) {
  ...
  while (arr.$isMongooseArray && !arr.$isMongooseDocumentArray) {
    arr = arr.casterConstructor;
    if (arr ***REMOVED*** null || typeof arr ***REMOVED***= 'function') {
...
SchemaArray.prototype.clone = function() {
  ...
  if (this.requiredValidator !***REMOVED*** undefined) {
...
SchemaArray.prototype._castForQuery = function(val, context) {
  ...
  if (val &&
    ...
    if (typeof val[Constructor.schema.options.discriminatorKey] ***REMOVED***= 'string' &&
