...
function isEmptyFilter(obj) {
  if (obj ***REMOVED*** null) return true;
  if (typeof obj !***REMOVED*** 'object') return true;
  if (Object.keys(obj).length ***REMOVED***= 0) return true;
  ...
  for (const key of ['$and', '$or', '$nor']) {
    if (Array.isArray(obj[key])) {
      ...
      if (obj[key].length ***REMOVED***= 0 || obj[key].every(item => isEmptyFilter(item))) {
        return true;
      }
    }
  }
 ...
 * #### Example:
 *
 *     query.$where('this.comments.length ***REMOVED***= 10 || this.name.length ***REMOVED***= 5')
 *
 *     // or
 *
 *     query.$where(function () {
 *       return this.comments.length ***REMOVED***= 10 || this.name.length ***REMOVED***= 5;
 *     })
 *
 * #### Note:
 *
...
Query.prototype.slice = function() {
  ...
  if (arguments.length ***REMOVED***= 1) {
    ...
    if (typeof arg ***REMOVED***= 'object' && !Array.isArray(arg)) {
    ...
    path = this._path;
    val = arguments[0];
  } else if (arguments.length ***REMOVED***= 2) {
    if ('number' ***REMOVED***= typeof arguments[0]) {
      this._ensurePath('slice');
      path = this._path;
  ...
  } else if (arguments.length ***REMOVED***= 3) {
    path = arguments[0];
...
Query.prototype.mod = function() {
  ...
  if (arguments.length ***REMOVED***= 1) {
    ...
    val = arguments[0];
    path = this._path;
  } else if (arguments.length ***REMOVED***= 2 && !Array.isArray(arguments[1])) {
    this._ensurePath('mod');
    val = [arguments[0], arguments[1]];
    path = this._path;
  } else if (arguments.length ***REMOVED***= 3) {
...
Query.prototype.select = function select() {
  ...
  function sanitizeValue(value) {
    return typeof value ***REMOVED***= 'string' && sanitizeProjection ? value = 1 : value;
  }
...
Query.prototype.toString = function toString() {
  if (this.op ***REMOVED***= 'count' ||
      this.op ***REMOVED***= 'countDocuments' ||
      this.op ***REMOVED***= 'find' ||
      this.op ***REMOVED***= 'findOne' ||
      this.op ***REMOVED***= 'deleteMany' ||
      this.op ***REMOVED***= 'deleteOne' ||
      this.op ***REMOVED***= 'findOneAndDelete' ||
      this.op ***REMOVED***= 'remove') {
    return `${this.model.modelName}.${this.op}(${util.inspect(this._conditions)})`;
  }
  if (this.op ***REMOVED***= 'distinct') {
    return `${this.model.modelName}.distinct('${this._distinct}', ${util.inspect(this._conditions)})`;
  }
  if (this.op ***REMOVED***= 'findOneAndReplace' ||
      this.op ***REMOVED***= 'findOneAndUpdate' ||
      this.op ***REMOVED***= 'replaceOne' ||
      this.op ***REMOVED***= 'update' ||
      this.op ***REMOVED***= 'updateMany' ||
      this.op ***REMOVED***= 'updateOne') {
...
Query.prototype.setOptions = function(options, overwrite) {
  ...
  if (options.lean ***REMOVED*** null && this.schema && 'lean' in this.schema.options) {
    this._mongooseOptions.lean = this.schema.options.lean;
  }

  if (typeof options.limit ***REMOVED***= 'string') {
    try {
  ...
  if (typeof options.skip ***REMOVED***= 'string') {
    try {
...
Query.prototype._fieldsForExec = function() {
  if (this._fields ***REMOVED*** null) {
    return null;
  }
  if (Object.keys(this._fields).length ***REMOVED***= 0) {
    return null;
  }
...
Query.prototype._optionsForExec = function(model) {
  ...
  if (options.upsert !***REMOVED*** void 0) {
...
Query.prototype._unsetCastError = function _unsetCastError() {
  if (this._error ***REMOVED*** null || !(this._error instanceof CastError)) {
    return;
  }
...
Query.prototype._find = async function _find() {
  ...
  if (docs.length ***REMOVED***= 0) {
    return docs;
  }

  if (!mongooseOptions.populate) {
    const versionKey = this.schema.options.versionKey;
    if (mongooseOptions.lean && mongooseOptions.lean.versionKey ***REMOVED***= false && versionKey) {
      docs.forEach((doc) => {
...
Query.prototype.find = function(conditions) {
  if (typeof conditions ***REMOVED***= 'function' ||
...
Query.prototype.findOne = function(conditions, projection, options) {
  if (typeof conditions ***REMOVED***= 'function' ||
      typeof projection ***REMOVED***= 'function' ||
      typeof options ***REMOVED***= 'function' ||
      typeof arguments[3] ***REMOVED***= 'function') {
...
Query.prototype.distinct = function(field, conditions, options) {
  if (typeof field ***REMOVED***= 'function' ||
      typeof conditions ***REMOVED***= 'function' ||
      typeof options ***REMOVED***= 'function' ||
      typeof arguments[3] ***REMOVED***= 'function') {
...
Query.prototype.sort = function(arg, options) {
  ...
  if (options != null && typeof options !***REMOVED*** 'object') {
    throw new Error('sort() options argument must be an object or nullish');
  }

  if (this.options.sort ***REMOVED*** null) {
    this.options.sort = {};
  }
  ...
  if (typeof arg ***REMOVED***= 'string') {
    const properties = arg.indexOf(' ') ***REMOVED***= -1 ? [arg] : arg.split(' ');
    for (let property of properties) {
      const ascend = '-' ***REMOVED*** property[0] ? -1 : 1;
      if (ascend ***REMOVED***= -1) {
  ...
  } else if (typeof arg ***REMOVED***= 'object' && arg != null && !(arg instanceof Map)) {
...
function _handleSortValue(val, key) {
  if (val ***REMOVED***= 1 || val ***REMOVED***= 'asc' || val ***REMOVED***= 'ascending') {
    return 1;
  }
  if (val ***REMOVED***= -1 || val ***REMOVED***= 'desc' || val ***REMOVED***= 'descending') {
    return -1;
  }
  if (val?.$meta != null) {
...
Query.prototype.deleteOne = function deleteOne(filter, options) {
  if (typeof filter ***REMOVED***= 'function' || typeof options ***REMOVED***= 'function' || typeof arguments[2] ***REMOVED***= 'function') {
...
function completeOne(model, doc, res, options, fields, userProvidedFields, pop, callback) {
  if (options.includeResultMetadata && doc ***REMOVED*** null) {
    _init(null);
    return null;
  }
...
Query.prototype.findOneAndUpdate = function(filter, doc, options) {
  if (typeof filter ***REMOVED***= 'function' ||
      typeof doc ***REMOVED***= 'function' ||
      typeof options ***REMOVED***= 'function' ||
      typeof arguments[3] ***REMOVED***= 'function') {
  ...
  if (options.new ***REMOVED*** null && options.returnDocument ***REMOVED*** null && options.returnOriginal ***REMOVED*** null && returnOriginal != null) {
...
Query.prototype._findOneAndUpdate = async function _findOneAndUpdate() {
  ...
  if (!this._update || Object.keys(this._update).length ***REMOVED***= 0) {
    if (options.upsert) {
    ...
    if (this._update.$set && Object.keys(this._update.$set).length ***REMOVED***= 0) {
...
Query.prototype.findOneAndReplace = function(filter, replacement, options) {
  if (typeof filter ***REMOVED***= 'function' ||
      typeof replacement ***REMOVED***= 'function' ||
      typeof options ***REMOVED***= 'function' ||
      typeof arguments[4] ***REMOVED***= 'function') {
...
function convertNewToReturnDocument(options) {
  ...
  if (typeof options.returnDocument ***REMOVED***= 'string') {
    options.returnOriginal = options.returnDocument ***REMOVED***= 'before';
  }
}
...
function _completeOneLean(schema, doc, path, res, opts, callback) {
  if (opts.lean && typeof opts.lean.transform ***REMOVED***= 'function') {
...
Query.prototype._mergeUpdate = function(doc) {
  ...
  if (doc ***REMOVED*** null || (typeof doc ***REMOVED***= 'object' && Object.keys(doc).length ***REMOVED***= 0)) {
    return;
  }
...
async function _updateThunk(op) {
  ...
  const isOverwriting = op ***REMOVED***= 'replaceOne';
  if (isOverwriting) {
    this._update = new this.model(this._update, null, true);
  } else {
    this._update = this._castUpdate(this._update);

    if (this._update ***REMOVED*** null || Object.keys(this._update).length ***REMOVED***= 0) {
...
Query.prototype.validate = async function validate(castedDoc, options, isOverwriting) {
  if (typeof arguments[3] ***REMOVED***= 'function') {
...
Query.prototype.updateMany = function(conditions, doc, options, callback) {
  if (typeof options ***REMOVED***= 'function') {
    ...
    callback = options;
    options = null;
  } else if (typeof doc ***REMOVED***= 'function') {
    // .update(doc, callback);
    callback = doc;
    doc = conditions;
    conditions = {};
    options = null;
  } else if (typeof conditions ***REMOVED***= 'function') {
    // .update(callback)
    callback = conditions;
    conditions = undefined;
    doc = undefined;
    options = undefined;
  } else if (typeof conditions ***REMOVED***= 'object' && !doc && !options && !callback) {
    // .update(doc)
    doc = conditions;
    conditions = undefined;
    options = undefined;
...
function _update(query, op, filter, doc, options, callback) {
  ...
  if (!(filter instanceof Query) &&
      filter != null &&
      filter.toString() !***REMOVED*** '[object Object]') {
...
Query.prototype.orFail = function(err) {
  this.transform(res => {
    switch (this.op) {
      ...
      case 'updateMany':
      case 'updateOne':
        if (res && res.matchedCount ***REMOVED***= 0) {
          throw _orFailError(err, this);
        }
        break;
      ...
      case 'findOneAndReplace':
        if (this.options.includeResultMetadata && res != null && res.value ***REMOVED*** null) {
          throw _orFailError(err, this);
        }
        if (!this.options.includeResultMetadata && res ***REMOVED*** null) {
          throw _orFailError(err, this);
        }
        break;
      case 'deleteMany':
      case 'deleteOne':
        if (res.deletedCount ***REMOVED***= 0) {
          throw _orFailError(err, this);
        }
        break;
      default:
...
function _orFailError(err, query) {
  if (typeof err ***REMOVED***= 'function') {
    err = err.call(query);
  }
...
Query.prototype.exec = async function exec(op) {
  if (typeof op ***REMOVED***= 'function' || (arguments.length >= 2 && typeof arguments[1] ***REMOVED***= 'function')) {
    throw new MongooseError('Query.prototype.exec() no longer accepts a callback');
  }

  if (typeof op ***REMOVED***= 'string') {
    this.op = op;
  }

  if (this.op ***REMOVED*** null) {
    throw new MongooseError('Query must have `op` before executing');
  }
  if (this.model ***REMOVED*** null) {
  ...
  if (this.options && this.options.sort && typeof this.options.sort ***REMOVED***= 'object' && this.options.sort.hasOwnProperty('')) {
...
function _executePostHooks(query, res, error, op) {
  if (query._queryMiddleware ***REMOVED*** null) {
    if (error != null) {
      throw error;
    }
    return res;
...
Query.prototype._castUpdate = function _castUpdate(obj) {
  ...
  if (this._mongooseOptions.overwriteDiscriminatorKey &&
    ...
    const _schema = Object.values(baseSchema.discriminators).find(
      discriminator => discriminator.discriminatorMapping.value ***REMOVED***= obj[discriminatorKey]
    );
    if (_schema != null) {
      schema = _schema;
    }
...
Query.prototype.populate = function() {
  ...
  if (this.options != null) {
    ...
    for (const populateOptions of res) {
      if (readConcern != null && (populateOptions && populateOptions.options && populateOptions.options.readConcern) ***REMOVED*** null) {
        populateOptions.options = populateOptions.options || {};
        populateOptions.options.readConcern = readConcern;
      }
      if (readPref != null && (populateOptions && populateOptions.options && populateOptions.options.readPreference) ***REMOVED*** null) {
        populateOptions.options = populateOptions.options || {};
  ...
  if (opts.lean != null) {
    ...
    for (const populateOptions of res) {
      if ((populateOptions && populateOptions.options && populateOptions.options.lean) ***REMOVED*** null) {
        populateOptions.options = populateOptions.options || {};
...
Query.prototype.cast = function(model, obj) {
  ...
  try {
    ...
    if (typeof err.setModel ***REMOVED***= 'function') {
      err.setModel(model);
    }
    throw err;
  }
...
Query.prototype.tailable = function(val, opts) {
  ...
  if (val != null && typeof val.constructor ***REMOVED***= 'function' && val.constructor.name ***REMOVED***= 'Object') {
    opts = val;
    val = true;
  }
  ...
  if (opts && typeof opts ***REMOVED***= 'object') {
    for (const key of Object.keys(opts)) {
      if (key ***REMOVED***= 'awaitData' || key ***REMOVED***= 'awaitdata') { // backwards compat, see gh-10875
...
Query.prototype.near = function() {
  ...
  if (arguments.length ***REMOVED***= 1) {
    ...
    } else if (typeof arguments[0] ***REMOVED***= 'string') {
      // just passing a path
      params.push(arguments[0]);
    } else if (utils.isObject(arguments[0])) {
      if (typeof arguments[0].spherical !***REMOVED*** 'boolean') {
    ...
    if (typeof arguments[0] ***REMOVED***= 'number' && typeof arguments[1] ***REMOVED***= 'number') {
      params.push({ center: [arguments[0], arguments[1]], spherical: sphere });
    } else if (typeof arguments[0] ***REMOVED***= 'string' && Array.isArray(arguments[1])) {
      params.push(arguments[0]);
      params.push({ center: arguments[1], spherical: sphere });
    } else if (typeof arguments[0] ***REMOVED***= 'string' && utils.isObject(arguments[1])) {
      params.push(arguments[0]);
      if (typeof arguments[1].spherical !***REMOVED*** 'boolean') {
    ...
    if (typeof arguments[0] ***REMOVED***= 'string' && typeof arguments[1] ***REMOVED***= 'number'
        && typeof arguments[2] ***REMOVED***= 'number') {
      params.push(arguments[0]);
...
Query.prototype.centerSphere = function() {
  if (arguments[0] != null && typeof arguments[0].constructor ***REMOVED***= 'function' && arguments[0].constructor.name ***REMOVED***= 'Object') {
    arguments[0].spherical = true;
  }

  if (arguments[1] != null && typeof arguments[1].constructor ***REMOVED***= 'function' && arguments[1].constructor.name ***REMOVED***= 'Object') {
