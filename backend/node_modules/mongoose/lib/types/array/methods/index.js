...
const methods = {
  ...
  $__getAtomics() {
    ...
    while (i--) {
      ...
      } else if (val != null && typeof val.valueOf ***REMOVED***= 'function') {
        val = val.valueOf();
      }
  ...
  _cast(value) {
    ...
    if (populated && value !***REMOVED*** null && value !***REMOVED*** undefined) {
      ...
      const isDisc = value.schema && value.schema.discriminatorMapping &&
          value.schema.discriminatorMapping.key !***REMOVED*** undefined;
      if (!isDisc) {
  ...
  _markModified(elem) {
    ...
    if (parent) {
      ...
      parent.markModified(dirtyPath, arguments.length !***REMOVED*** 0 ? elem : parent);
    }
  ...
  _registerAtomic(op, val) {
    ...
    if (op ***REMOVED***= '$pop' && !('$pop' in atomics)) {
      const _this = this;
    ...
    if (op ***REMOVED***= '$pullAll' || op ***REMOVED***= '$addToSet') {
      atomics[op] || (atomics[op] = []);
      atomics[op] = atomics[op].concat(val);
    } else if (op ***REMOVED***= '$pullDocs') {
      ...
      if (val[0] instanceof ArraySubdocument) {
        ...
        Array.prototype.push.apply(selector, val.map(v => {
          return v.toObject({
            transform: (doc, ret) => {
              if (v ***REMOVED*** null || v.$__ ***REMOVED*** null) {
                return ret;
              }
    ...
    } else if (op ***REMOVED***= '$push') {
      atomics.$push = atomics.$push || { $each: [] };
      if (val != null && utils.hasUserDefinedProperty(val, '$each')) {
        atomics.$push = val;
      } else {
        if (val.length ***REMOVED***= 1) {
      ...
      switch (type) {
        ...
        case 'date':
          found = this.some(function(d) {
            return +d ***REMOVED***= val;
          });
          break;
        case 'ObjectId':
          found = this.find(o => o.toString() ***REMOVED***= v.toString());
          break;
        default:
  ...
  indexOf(obj, fromIndex) {
    ...
    fromIndex = fromIndex ***REMOVED*** null ? 0 : fromIndex;
    const len = this.length;
    for (let i = fromIndex; i < len; ++i) {
      if (obj ***REMOVED*** this[i]) {
        return i;
      }
    }
    return -1;
  ...
  pull() {
    ...
    if (values[0] instanceof ArraySubdocument) {
      this._registerAtomic('$pullDocs', values.map(function(v) {
        ...
        if (_id ***REMOVED***= undefined || v.$isDefault('_id')) {
          return v;
        }
        return _id;
      }));
  ...
  push() {
    ...
    if (this[arraySchemaSymbol] ***REMOVED*** null) {
    ...
    if (isOverwrite) {
      ...
      if ((atomics.$push && atomics.$push.$each && atomics.$push.$each.length || 0) !***REMOVED*** 0 &&
...
function _isAllSubdocs(docs, ref) {
  ...
  for (const arg of docs) {
    ...
    if (!(arg instanceof Document) ||
      (model.modelName !***REMOVED*** ref && model.baseModelName !***REMOVED*** ref)) {
      return false;
    }
  }
...
function _minimizePath(obj, parts, i) {
  if (typeof parts ***REMOVED***= 'string') {
    if (parts.indexOf('.') ***REMOVED***= -1) {
      return;
    }
  ...
  if (obj ***REMOVED*** null || typeof obj !***REMOVED*** 'object') {
    return;
  }

  _minimizePath(obj[parts[0]], parts, i + 1);
  if (obj[parts[0]] != null && typeof obj[parts[0]] ***REMOVED***= 'object' && Object.keys(obj[parts[0]]).length ***REMOVED***= 0) {
    delete obj[parts[0]];
  }
}
...
function _depopulateIfNecessary(arr, docs) {
  ...
  for (const doc of docs) {
    ...
    if (typeof doc !***REMOVED*** 'object' || doc instanceof String || doc instanceof Number || doc instanceof Buffer || utils.isMongooseType(doc)) {
...
for (const method of returnVanillaArrayMethods) {
  if (Array.prototype[method] ***REMOVED*** null) {
    continue;
  }
