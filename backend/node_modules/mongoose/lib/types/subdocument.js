...
function Subdocument(value, fields, parent, skipId, options) {
  if (typeof skipId ***REMOVED***= 'object' && skipId != null && options ***REMOVED*** null) {
    options = skipId;
    skipId = undefined;
  }
  if (parent != null) {
...
Subdocument.prototype.markModified = function(path) {
  ...
  if (parent ***REMOVED*** null || fullPath ***REMOVED*** null) {
    return;
  }
...
Subdocument.prototype.isModified = function(paths, options, modifiedPaths) {
  const parent = this.$parent();
  if (parent != null) {
    if (Array.isArray(paths) || typeof paths ***REMOVED***= 'string') {
...
Subdocument.prototype.invalidate = function(path, err, val) {
  ...
  } else if (err.kind ***REMOVED***= 'cast' || err.name ***REMOVED***= 'CastError' || fullPath ***REMOVED*** null) {
    throw err;
  }
...
Subdocument.prototype.ownerDocument = function() {
  ...
  while (true) {
    if (typeof parent.$__pathRelativeToParent !***REMOVED*** 'function') {
      break;
    }
    paths.unshift(parent.$__pathRelativeToParent(void 0, true));
    const _parent = parent.$parent();
    if (_parent ***REMOVED*** null) {
      break;
    }
    parent = _parent;
...
Subdocument.prototype.$toObject = function $toObject(options, json) {
  ...
  if (Object.keys(ret).length ***REMOVED***= 0 && options?._calledWithOptions != null) {
