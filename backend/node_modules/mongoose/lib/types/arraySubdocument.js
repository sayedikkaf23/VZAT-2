...
ArraySubdocument.prototype.$__pathRelativeToParent = function(path, skipIndex) {
  if (this.__index ***REMOVED*** null || (!this.__parentArray || !this.__parentArray.$path)) {
    return null;
  }
  if (skipIndex) {
    return path ***REMOVED*** null ? this.__parentArray.$path() : this.__parentArray.$path() + '.' + path;
  }
 ...
 *
 *     doc.docArr[0].parentArray() ***REMOVED***= doc.docArr; // true
 *
 * @api public
 * @method parentArray
