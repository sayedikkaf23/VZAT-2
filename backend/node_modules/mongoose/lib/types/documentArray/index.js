...
function MongooseDocumentArray(values, path, doc, schematype) {
  ...
  if (Array.isArray(values)) {
    if (values[arrayPathSymbol] ***REMOVED***= path &&
        values[arrayParentSymbol] ***REMOVED***= doc) {
  ...
  const proxy = new Proxy(__array, {
    get: function(target, prop) {
      if (prop ***REMOVED***= 'isMongooseArray' ||
          prop ***REMOVED***= 'isMongooseArrayProxy' ||
          prop ***REMOVED***= 'isMongooseDocumentArray' ||
          prop ***REMOVED***= 'isMongooseDocumentArrayProxy') {
        return true;
      }
    ...
    set: function(target, prop, value) {
      if (typeof prop ***REMOVED***= 'string' && numberRE.test(prop)) {
