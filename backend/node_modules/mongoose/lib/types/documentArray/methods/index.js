...
const methods = {
  ...
  _cast(value, index, options) {
    ...
    if (isInstance ||
        ...
        (value && value.constructor && value.constructor.baseCasterConstructor ***REMOVED***= Constructor)) {
    ...
    if (value ***REMOVED***= undefined || value ***REMOVED***= null) {
      return null;
    }
    ...
    if (value &&
      ...
      if (typeof value[Constructor.schema.options.discriminatorKey] ***REMOVED***= 'string' &&
  ...
  id(id) {
    ...
    for (const val of this) {
      ...
      if (_id ***REMOVED***= null || typeof _id ***REMOVED***= 'undefined') {
        continue;
      } else if (_id instanceof Document) {
        sid || (sid = String(id));
        if (sid ***REMOVED*** _id._id) {
          return val;
        }
      } else if (!isBsonType(id, 'ObjectId') && !isBsonType(_id, 'ObjectId')) {
        if (id ***REMOVED*** _id || utils.deepEqual(id, _id)) {
          return val;
        }
      } else if (casted ***REMOVED*** _id) {
        return val;
      }
    }
  ...
  toObject(options) {
    ...
    return [].concat(this.map(function(doc) {
      ...
      if (typeof doc.toObject !***REMOVED*** 'function') {
        return doc;
      }
  ...
  create(obj) {
    ...
    if (obj &&
        ...
        Constructor.schema.options &&
        Constructor.schema.options.discriminatorKey) {
      if (typeof obj[Constructor.schema.options.discriminatorKey] ***REMOVED***= 'string' &&
...
function _updateParentPopulated(arr) {
  ...
  if (!parent || parent.$__.populated ***REMOVED*** null) return;
