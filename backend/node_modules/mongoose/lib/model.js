 ...
 *     UserModel.connection ***REMOVED***= mongoose.connection; // true
 *
 ...
 *
 *     UserModel.connection ***REMOVED***= mongoose.connection; // false
 *     UserModel.connection ***REMOVED***= conn2; // true
 *
 *     conn2.model('User') ***REMOVED***= UserModel; // true
...
Model.prototype.$__handleSave = function(options, callback) {
  ...
  if (typeof options.writeConcern !***REMOVED*** 'undefined') {
  ...
  if (options.pathsToSave) {
    for (const key in delta[1]['$set']) {
      if (options.pathsToSave.includes(key)) {
        continue;
      } else if (options.pathsToSave.some(pathToSave => key.slice(0, pathToSave.length) ***REMOVED***= pathToSave && key.charAt(pathToSave.length) ***REMOVED***= '.')) {
        continue;
      } else {
  ...
  if (delta) {
    ...
    if (this.$__schema.options.minimize) {
      for (const updateOp of Object.values(update)) {
        if (updateOp ***REMOVED*** null) {
          continue;
        }
        for (const key of Object.keys(updateOp)) {
          if (updateOp[key] ***REMOVED*** null || typeof updateOp[key] !***REMOVED*** 'object') {
            continue;
          }
          ...
          if (Object.keys(updateOp[key]).length ***REMOVED***= 0) {
            delete updateOp[key];
  ...
  this.$__handleSave(options, (error, result) => {
    ...
    if (writeConcern !***REMOVED*** 0) {
      ...
      if (versionBump && !this.$__.inserting) {
        const doIncrement = VERSION_INC ***REMOVED***= (VERSION_INC & this.$__.version);
...
Model.prototype.save = async function save(options) {
  if (typeof options ***REMOVED***= 'function' || typeof arguments[1] ***REMOVED***= 'function') {
...
Model.prototype.$__version = function(where, delta) {
  ...
  if (VERSION_WHERE ***REMOVED***= (VERSION_WHERE & this.$__.version)) {
    const value = this.$__getValue(key);
    if (value != null) where[key] = value;
  }

  if (VERSION_INC ***REMOVED***= (VERSION_INC & this.$__.version)) {
...
Model.prototype.$__where = function _where(where) {
  ...
  if (this._doc._id ***REMOVED***= void 0) {
...
Model.prototype.deleteOne = function deleteOne(options) {
  if (typeof options ***REMOVED***= 'function' ||
      typeof arguments[1] ***REMOVED***= 'function') {
...
Model.exists = function exists(filter, options) {
  ...
  if (typeof arguments[2] ***REMOVED***= 'function') {
...
Model.discriminator = function(name, schema, options) {
  let model;
  if (typeof name ***REMOVED***= 'function') {
    model = name;
  ...
  const clone = typeof options.clone ***REMOVED***= 'boolean' ? options.clone : true;
  const mergePlugins = typeof options.mergePlugins ***REMOVED***= 'boolean' ? options.mergePlugins : true;
  const overwriteModels = typeof options.overwriteModels ***REMOVED***= 'boolean' ? options.overwriteModels : false;
...
function _checkContext(ctx, fnName) {
  ...
  if (ctx ***REMOVED*** null || ctx ***REMOVED***= global) {
  ...
  } else if (ctx[modelSymbol] ***REMOVED*** null) {
    throw new MongooseError('`Model.' + fnName + '()` cannot run without a ' +
...
Model.init = function init() {
  ...
  if (typeof arguments[0] ***REMOVED***= 'function') {
...
Model.createCollection = async function createCollection(options) {
  ...
  if (typeof arguments[0] ***REMOVED***= 'function' || typeof arguments[1] ***REMOVED***= 'function') {
  ...
  if (capped != null) {
    if (typeof capped ***REMOVED***= 'number') {
      options = Object.assign({ capped: true, size: capped }, options);
    } else if (typeof capped ***REMOVED***= 'object') {
  ...
  try {
    ...
    if (err != null && (err.name !***REMOVED*** 'MongoServerError' || err.code !***REMOVED*** 48)) {
      await new Promise((resolve, reject) => {
...
Model.diffIndexes = async function diffIndexes(options) {
  ...
  let dbIndexes = await model.listIndexes().catch(err => {
    if (err.codeName ***REMOVED*** 'NamespaceNotFound') {
      return undefined;
    }
    throw err;
  });
  if (dbIndexes ***REMOVED***= undefined) {
    dbIndexes = [];
  }
...
function _ensureIndexes(model, options, callback) {
  ...
  function create() {
    if (options._automatic) {
      if (model.schema.options.autoIndex ***REMOVED***= false ||
          (model.schema.options.autoIndex ***REMOVED*** null && model.db.config.autoIndex ***REMOVED***= false)) {
        return done();
      }
    }
    ...
    if (options._automatic && index[1]._autoIndex ***REMOVED***= false) {
      return create();
    }
...
Model.translateAliases = function translateAliases(fields, errorOnDuplicates) {
  ...
  if (typeof fields ***REMOVED***= 'object') {
...
Model.deleteOne = function deleteOne(conditions, options) {
  ...
  if (typeof arguments[0] ***REMOVED***= 'function' || typeof arguments[1] ***REMOVED***= 'function' || typeof arguments[2] ***REMOVED***= 'function') {
    throw new MongooseError('Model.prototype.deleteOne() no longer accepts a callback');
  }
...
Model.find = function find(conditions, projection, options) {
  ...
  if (typeof arguments[0] ***REMOVED***= 'function' || typeof arguments[1] ***REMOVED***= 'function' || typeof arguments[2] ***REMOVED***= 'function' || typeof arguments[3] ***REMOVED***= 'function') {
...
Model.findById = function findById(id, projection, options) {
  ...
  if (typeof id ***REMOVED***= 'undefined') {
    id = null;
  }
 ...
 *
 *     Blog.$where('this.username.indexOf("val") !***REMOVED*** -1').exec(function (err, docs) {});
 *
...
Model.create = async function create(doc, options) {
  if (typeof options ***REMOVED***= 'function' ||
      typeof arguments[2] ***REMOVED***= 'function') {
  ...
  if (Array.isArray(doc)) {
    args = doc;
    options = options != null && typeof options ***REMOVED***= 'object' ? options : {};
  } else {
    const last = arguments[arguments.length - 1];
    options = {};
    const hasCallback = typeof last ***REMOVED***= 'function' ||
      typeof options ***REMOVED***= 'function' ||
      typeof arguments[2] ***REMOVED***= 'function';
    if (hasCallback) {
      throw new MongooseError('Model.create() no longer accepts a callback');
    } else {
    ...
    if (args.length ***REMOVED***= 2 &&
        args[0] != null &&
        args[1] != null &&
        args[0].session ***REMOVED*** null &&
        last &&
        getConstructorName(last.session) ***REMOVED***= 'ClientSession' &&
  ...
  let res = [];
  const immediateError = typeof options.aggregateErrors ***REMOVED***= 'boolean' ? !options.aggregateErrors : true;
  ...
  if (options.ordered) {
    ...
    res = res.map(result => result.status ***REMOVED***= 'fulfilled' ? result.value : result.reason);
  } else {
    let firstError = null;
  ...
  if (!Array.isArray(doc) && args.length ***REMOVED***= 1) {
    return res[0];
  }
...
Model.$__insertMany = function(arr, options, callback) {
  ...
  const ordered = typeof options.ordered ***REMOVED***= 'boolean' ? options.ordered : true;
  const throwOnValidationError = typeof options.throwOnValidationError ***REMOVED***= 'boolean' ? options.throwOnValidationError : false;
  ...
  const toExecute = arr.map((doc, index) =>
    callback => {
      ...
      if (!(doc instanceof _this)) {
        if (doc != null && typeof doc !***REMOVED*** 'object') {
  ...
  parallelLimit(toExecute, limit, function(error, docs) {
    ...
    if (docAttributes.length ***REMOVED***= 0) {
    ...
    const docObjects = lean ? docAttributes : docAttributes.map(function(doc) {
      ...
      const shouldSetTimestamps = (!options || options.timestamps !***REMOVED*** false) && doc.initializeTimestamps && (!doc.$__ || doc.$__.timestamps !***REMOVED*** false);
    ...
    _this.$__collection.insertMany(docObjects, options).then(
      res => {
        ...
        if (ordered ***REMOVED***= false && throwOnValidationError && validationErrors.length > 0) {
          for (let i = 0; i < results.length; ++i) {
            if (results[i] ***REMOVED***= void 0) {
              results[i] = docs[i];
            }
          }
          return callback(new MongooseBulkWriteError(
      ...
      error => {
        ...
        if (error.writeErrors ***REMOVED*** null &&
        ...
        if (rawResult && ordered ***REMOVED***= false) {
...
Model.bulkWrite = async function bulkWrite(ops, options) {
  ...
  const ordered = options.ordered ***REMOVED*** null ? true : options.ordered;

  if (ops.length ***REMOVED***= 0) {
  ...
  if (ordered) {
    ...
    const results = [];
    await new Promise((resolve) => {
      if (validations.length ***REMOVED***= 0) {
        return resolve();
      }
...
Model.bulkSave = async function bulkSave(documents, options) {
  ...
  if (bulkWriteError != null && bulkWriteError.name !***REMOVED*** 'MongoBulkWriteError') {
  ...
  for (let i = 0; i < documents.length; i++) {
    ...
    const documentError = bulkWriteError && bulkWriteError.writeErrors.find(writeError => {
      ...
      return writeErrorDocumentId.toString() ***REMOVED***= document._doc._id.toString();
    });

    if (documentError ***REMOVED*** null) {
...
Model.castObject = function castObject(obj, options) {
  ...
  for (const path of paths) {
    ...
    const pieces = path.indexOf('.') ***REMOVED***= -1 ? [path] : path.split('.');
    let cur = ret;
    for (let i = 0; i < pieces.length - 1; ++i) {
      if (cur[pieces[i]] ***REMOVED*** null) {
...
Model.buildBulkWriteOperations = function buildBulkWriteOperations(documents, options) {
  ...
  const writeOperations = documents.map((document, i) => {
    if (!options.skipValidation) {
      ...
      if (options.validateBeforeSave ***REMOVED*** null || options.validateBeforeSave) {
  ...
  function setDefaultOptions() {
    options = options || {};
    if (options.skipValidation ***REMOVED*** null) {
...
function _update(model, op, conditions, doc, options) {
  ...
  options = typeof options ***REMOVED***= 'function' ? options : clone(options);
...
Model.aggregate = function aggregate(pipeline, options) {
  ...
  if (typeof options ***REMOVED***= 'function' || typeof arguments[2] ***REMOVED***= 'function') {
...
Model.validate = async function validate(obj, pathsOrOptions, context) {
  if ((arguments.length < 3) || (arguments.length ***REMOVED***= 3 && typeof arguments[2] ***REMOVED***= 'function')) {
  ...
  if (typeof context ***REMOVED***= 'function' || typeof arguments[3] ***REMOVED***= 'function') {
  ...
  if (pathsOrOptions != null) {
    const _pathsToValidate = typeof pathsOrOptions ***REMOVED***= 'string' ? new Set(pathsOrOptions.split(' ')) : Array.isArray(pathsOrOptions) ? new Set(pathsOrOptions) : new Set(paths);
    paths = paths.filter(p => {
      if (pathsOrOptions.pathsToSkip) {
        if (Array.isArray(pathsOrOptions.pathsToSkip)) {
          if (pathsOrOptions.pathsToSkip.find(x => x ***REMOVED*** p)) {
            return false;
          }
        } else if (typeof pathsOrOptions.pathsToSkip ***REMOVED*** 'string') {
...
Model.populate = async function populate(docs, paths) {
  ...
  if (typeof paths ***REMOVED***= 'function' || typeof arguments[2] ***REMOVED***= 'function') {
...
async function _populatePath(model, docs, populateOptions) {
  if (populateOptions.strictPopulate ***REMOVED*** null) {
  ...
  if (docs.length ***REMOVED***= 0 || docs.every(utils.isNullOrUndefined)) {
    return;
  }
  ...
  for (let i = 0; i < len; ++i) {
    ...
    assignmentOpts.excludeId = excludeIdReg.test(select) || (select && select._id ***REMOVED***= 0);
    ...
    if (ids.length ***REMOVED***= 0 || ids.every(utils.isNullOrUndefined)) {
    ...
    hasOne = true;
    if (typeof populateOptions.foreignField ***REMOVED***= 'string') {
    ...
    if (assignmentOpts.excludeId) {
      ...
      if (typeof select ***REMOVED***= 'string') {
        select = select.replace(excludeIdRegGlobal, ' ');
      } else if (Array.isArray(select)) {
        select = select.filter(field => field !***REMOVED*** '-_id');
      } else {
...
function _execPopulateQuery(mod, match, select) {
  ...
  if (subPopulate) {
    ...
    if (mod.model.baseModelName != null) {
      ...
      } else if (typeof subPopulate ***REMOVED***= 'string') {
    ...
    } else if (typeof subPopulate ***REMOVED***= 'object') {
    ...
    for (const foreignField of mod.foreignField) {
      ...
      if (Array.isArray(_val)) {
        ...
        for (let __val of _val) {
          ...
          if (__val?.constructor?.name ***REMOVED***= 'Binary' && __val.sub_type ***REMOVED***= 4 && typeof __val.toUUID ***REMOVED***= 'function') {
            // Workaround for gh-15315 because Mongoose UUIDs don't use BSON UUIDs yet.
            key = String(__val.toUUID());
          } else if (__val?.constructor?.name ***REMOVED***= 'Buffer' && __val._subtype ***REMOVED***= 4 && typeof __val.toUUID ***REMOVED***= 'function') {
            key = String(__val.toUUID());
          } else {
            key = String(__val);
          }
        ...
        if (_val?.constructor?.name ***REMOVED***= 'Binary' && _val.sub_type ***REMOVED***= 4 && typeof _val.toUUID ***REMOVED***= 'function') {
          // Workaround for gh-15315 because Mongoose UUIDs don't use BSON UUIDs yet.
          key = String(_val.toUUID());
        } else if (_val?.constructor?.name ***REMOVED***= 'Buffer' && _val._subtype ***REMOVED***= 4 && typeof _val.toUUID ***REMOVED***= 'function') {
          key = String(_val.toUUID());
        } else {
          key = String(_val);
        }
        if (rawDocs[key]) {
          if (Array.isArray(rawDocs[key])) {
            ...
            rawDocs[key].constructor !***REMOVED*** val.constructor ||
            (rawDocs[key] instanceof Document ? String(rawDocs[key]._doc._id) : String(rawDocs[key]._id)) !***REMOVED*** (val instanceof Document ? String(val._doc._id) : String(val._id))) {
...
Model.compile = function compile(name, schema, collectionName, connection, base) {
  const versioningEnabled = schema.options.versionKey !***REMOVED*** false;
  ...
  let model;
  if (typeof name ***REMOVED***= 'function' && name.prototype instanceof Model) {
    model = name;
    name = model.name;
    ...
    model = function model(doc, fields, skipId) {
      ...
      if (model.discriminators ***REMOVED*** null || doc ***REMOVED*** null || doc[discriminatorKey] ***REMOVED*** null) {
  ...
  if (schema.options.autoCreate !***REMOVED*** void 0) {
...
Model.__subclass = function subclass(conn, schema, collection) {
  ...
  const s = schema && typeof schema !***REMOVED*** 'string'
    ? schema
...
Model._applyQueryMiddleware = function _applyQueryMiddleware() {
  ...
  const queryMiddleware = this.schema.s.hooks.filter(hook => {
    ...
    if (hook.name ***REMOVED***= 'validate') {
      return !!contexts.query;
    }
    if (hook.name ***REMOVED***= 'deleteOne' || hook.name ***REMOVED***= 'updateOne') {
      return !!contexts.query || Object.keys(contexts).length ***REMOVED***= 0;
    }
