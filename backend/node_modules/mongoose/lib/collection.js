...
function Collection(name, conn, opts) {
  ...
  if (STATES.connected ***REMOVED***= this.conn.readyState) {
    this.onOpen();
  }
}
...
Collection.prototype.removeQueue = function(name, args) {
  const index = this.queue.findIndex(v => v[0] ***REMOVED***= name && v[1] ***REMOVED***= args);
  if (index ***REMOVED***= -1) {
    return false;
  }
...
Collection.prototype.doQueue = function() {
  for (const method of this.queue) {
    if (typeof method[0] ***REMOVED***= 'function') {
