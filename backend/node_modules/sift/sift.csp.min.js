(function (global, factory) {
    typeof exports ***REMOVED***= 'object' && typeof module !***REMOVED*** 'undefined' ? factory(exports) :
    typeof define ***REMOVED***= 'function' && define.amd ? define(['exports'], factory) :
    (global = typeof globalThis !***REMOVED*** 'undefined' ? globalThis : global || self, factory(global.sift = {}));
    ...
    ***************************************************************************** */
    ...
    function __extends(d, b) {
        if (typeof b !***REMOVED*** "function" && b !***REMOVED*** null)
            throw new TypeError("Class extends value " + String(b) + " is not a constructor or null");
        extendStatics(d, b);
        function __() { this.constructor = d; }
        d.prototype = b ***REMOVED***= null ? Object.create(b) : (__.prototype = b.prototype, new __());
    }

    typeof SuppressedError ***REMOVED***= "function" ? SuppressedError : function (error, suppressed, message) {
    ...
    var typeChecker = function (type) {
        ...
        return function (value) {
            return getClassName(value) ***REMOVED***= typeString;
        };
    };
    ...
    var comparable = function (value) {
        ...
        else if (value && typeof value.toJSON ***REMOVED***= "function") {
            return value.toJSON();
        }
        return value;
    };
    var coercePotentiallyNull = function (value) {
        return value ***REMOVED*** null ? null : value;
    };
    ...
    var isVanillaObject = function (value) {
        return (value &&
            (value.constructor ***REMOVED***= Object ||
                value.constructor ***REMOVED***= Array ||
                value.constructor.toString() ***REMOVED***= "function Object() { [native code] }" ||
                value.constructor.toString() ***REMOVED***= "function Array() { [native code] }") &&
            !value.toJSON);
    };
    var equals = function (a, b) {
        if (a ***REMOVED*** null && a ***REMOVED*** b) {
            return true;
        }
        if (a ***REMOVED***= b) {
            return true;
        }
        if (Object.prototype.toString.call(a) !***REMOVED*** Object.prototype.toString.call(b)) {
            return false;
        }
        if (isArray(a)) {
            if (a.length !***REMOVED*** b.length) {
                return false;
            }
            ...
            if (Object.keys(a).length !***REMOVED*** Object.keys(b).length) {
                return false;
            }
            for (var key in a) {
    ...
    var walkKeyPathValues = function (item, keyPath, next, depth, key, owner) {
        ...
        if (depth ***REMOVED***= keyPath.length || item ***REMOVED*** null) {
            return next(item, key, owner, depth ***REMOVED***= 0, depth ***REMOVED***= keyPath.length);
        }
    ...
    var QueryOperation = /** @class */ (function (_super) {
        ...
        function QueryOperation() {
            var _this = _super !***REMOVED*** null && _super.apply(this, arguments) || this;
            _this.propop = true;
            return _this;
        }
        /**
    ...
    var createTester = function (a, compare) {
        ...
        if (a instanceof RegExp) {
            return function (b) {
                var result = typeof b ***REMOVED***= "string" && a.test(b);
                a.lastIndex = 0;
                return result;
            };
        }
    ...
    var numericalOperation = function (createTester) {
        return numericalOperationCreator(function (params, owneryQuery, options, name) {
            ...
            return new EqualsOperation(function (b) {
                ...
                return (typeof comparable(actualValue) ***REMOVED***= typeofParams && test(actualValue));
    ...
    var containsOperation = function (query, options) {
        for (var key in query) {
            if (options.operations.hasOwnProperty(key) || key.charAt(0) ***REMOVED***= "$")
                return true;
        }
        return false;
    };
    ...
    var createQueryOperation = function (query, owneryQuery, _a) {
        if (owneryQuery ***REMOVED***= void 0) { owneryQuery = null; }
        var _b = _a ***REMOVED***= void 0 ? {} : _a, compare = _b.compare, operations = _b.operations;
        var options = {
    ...
    var createQueryTester = function (query, options) {
        if (options ***REMOVED***= void 0) { options = {}; }
    ...
    var $ElemMatch = /** @class */ (function (_super) {
        ...
        $ElemMatch.prototype.init = function () {
            if (!this.params || typeof this.params !***REMOVED*** "object") {
    ...
    var $Size = /** @class */ (function (_super) {
        ...
        $Size.prototype.next = function (item) {
            if (isArray(item) && item.length ***REMOVED***= this.params) {
                this.done = true;
                this.keep = true;
            }
            // if (parent && parent.length ***REMOVED***= this.params) {
            //   this.done = true;
            //   this.keep = true;
            // }
        };
    ...
    var $Nin = /** @class */ (function (_super) {
        ...
        $Nin.prototype.next = function (item, key, owner, root) {
            ...
            if (isArray(owner) && !root) {
                ...
                else if (key ***REMOVED*** owner.length - 1) {
                    this.keep = true;
                    this.done = true;
                }
            }
    ...
    var $Exists = /** @class */ (function (_super) {
        ...
        $Exists.prototype.next = function (item, key, owner, root, leaf) {
            ...
            else if (owner.hasOwnProperty(key) ***REMOVED***= this.params) {
                this.done = true;
                this.keep = true;
            }
        };
    ...
    var $lte = numericalOperation(function (params) { return function (b) {
        return b ***REMOVED***= params || b <= params;
    }; });
    ...
    var $mod = function (_a, owneryQuery, options) {
        ...
        return new EqualsOperation(function (b) { return comparable(b) % mod ***REMOVED***= equalsValue; }, owneryQuery, options);
    };
    ...
    var typeAliases = {
        number: function (v) { return typeof v ***REMOVED***= "number"; },
        string: function (v) { return typeof v ***REMOVED***= "string"; },
        bool: function (v) { return typeof v ***REMOVED***= "boolean"; },
        array: function (v) { return Array.isArray(v); },
        null: function (v) { return v ***REMOVED***= null; },
        timestamp: function (v) { return v instanceof Date; },
    };
    var $type = function (clazz, owneryQuery, options) {
        return new EqualsOperation(function (b) {
            if (typeof clazz ***REMOVED***= "string") {
                if (!typeAliases[clazz]) {
                    throw new Error("Type alias does not exist");
                }
                return typeAliases[clazz](b);
            }
            return b != null ? b instanceof clazz || b.constructor ***REMOVED***= clazz : false;
        }, owneryQuery, options);
    };
