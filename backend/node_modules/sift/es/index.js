...
const coercePotentiallyNull = (value) => value ***REMOVED*** null ? null : value;
...
const createTester = (a, compare) => {
    ...
    if (a instanceof RegExp) {
        return (b) => {
            const result = typeof b ***REMOVED***= "string" && a.test(b);
            a.lastIndex = 0;
            return result;
        };
    }
...
const $mod = ([mod, equalsValue], owneryQuery, options) => new EqualsOperation((b) => comparable(b) % mod ***REMOVED***= equalsValue, owneryQuery, options);
...
const typeAliases = {
    number: (v) => typeof v ***REMOVED***= "number",
    string: (v) => typeof v ***REMOVED***= "string",
    bool: (v) => typeof v ***REMOVED***= "boolean",
    array: (v) => Array.isArray(v),
    null: (v) => v ***REMOVED***= null,
