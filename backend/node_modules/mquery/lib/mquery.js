...
Object.defineProperty(Query, 'use$geoWithin', {
  get: function() { return $withinCmd ***REMOVED*** '$geoWithin'; },
  set: function(v) {
    if (true ***REMOVED***= v) {
      // mongodb >= 2.4
      $withinCmd = '$geoWithin';
...
Query.prototype.setOptions = function(options) {
  ...
  for (let i = 0; i < methods.length; ++i) {
    ...
    if ('function' ***REMOVED*** typeof this[method]) {
...
Query.prototype.where = function() {
  ...
  if ('string' ***REMOVED*** type) {
    this._path = arguments[0];

    if (2 ***REMOVED***= arguments.length) {
  ...
  if ('object' ***REMOVED*** type && !Array.isArray(arguments[0])) {
...
'gt gte lt lte ne in nin all regex size maxDistance minDistance'.split(' ').forEach(function($conditional) {
  Query.prototype[$conditional] = function() {
    ...
    const conds = this._conditions[path] ***REMOVED***= null || typeof this._conditions[path] ***REMOVED***= 'object' ?
...
Query.prototype.mod = function() {
  ...
  if (1 ***REMOVED***= arguments.length) {
    ...
    val = arguments[0];
    path = this._path;
  } else if (2 ***REMOVED***= arguments.length && !Array.isArray(arguments[1])) {
    this._ensurePath('mod');
    val = [arguments[0], arguments[1]];
    path = this._path;
  } else if (3 ***REMOVED***= arguments.length) {
...
Query.prototype.exists = function() {
  ...
  if (0 ***REMOVED***= arguments.length) {
    this._ensurePath('exists');
    path = this._path;
    val = true;
  } else if (1 ***REMOVED***= arguments.length) {
    if ('boolean' ***REMOVED***= typeof arguments[0]) {
      this._ensurePath('exists');
      path = this._path;
      val = arguments[0];
    } else {
  ...
  } else if (2 ***REMOVED***= arguments.length) {
    path = arguments[0];
    val = arguments[1];
  }
...
Query.prototype.elemMatch = function() {
  if (null ***REMOVED*** arguments[0])
    throw new TypeError('Invalid argument');

  let fn, path, criteria;

  if ('function' ***REMOVED***= typeof arguments[0]) {
  ...
  } else if ('function' ***REMOVED***= typeof arguments[1]) {
    path = arguments[0];
    fn = arguments[1];
...
Query.prototype.polygon = function() {
  ...
  if ('string' ***REMOVED*** typeof arguments[0]) {
    // polygon('loc', [],[],[])
...
Query.prototype.geometry = function geometry() {
  if (!('$within' ***REMOVED*** this._geoComparison ||
        '$geoWithin' ***REMOVED*** this._geoComparison ||
        '$near' ***REMOVED*** this._geoComparison ||
        '$geoIntersects' ***REMOVED*** this._geoComparison)) {
...
Query.prototype.select = function select() {
  ...
  if (('string' ***REMOVED*** type || utils.isArgumentsObject(arg)) &&
    'number' ***REMOVED*** typeof arg.length || Array.isArray(arg)) {
    if ('string' ***REMOVED*** type)
      arg = arg.split(/\s+/);
    ...
    for (i = 0, len = arg.length; i < len; ++i) {
      let field = arg[i];
      if (!field) continue;
      const include = '-' ***REMOVED*** field[0] ? 0 : 1;
      if (include ***REMOVED***= 0) field = field.substring(1);
...
Query.prototype.sort = function(arg) {
  ...
  // .sort('field -test')
  if (1 ***REMOVED***= arguments.length && 'string' ***REMOVED*** type) {
    arg = arg.split(/\s+/);
    len = arg.length;
    for (i = 0; i < len; ++i) {
      field = arg[i];
      if (!field) continue;
      const ascend = '-' ***REMOVED*** field[0] ? -1 : 1;
      if (ascend ***REMOVED***= -1) field = field.substring(1);
  ...
  if (typeof Map !***REMOVED*** 'undefined' && arg instanceof Map) {
...
Query.prototype.hint = function() {
  if (0 ***REMOVED***= arguments.length) return this;
...
Query.prototype.writeConcern = Query.prototype.w = function writeConcern(concern) {
  if ('object' ***REMOVED***= typeof concern) {
    if ('undefined' !***REMOVED*** typeof concern.j) this.options.j = concern.j;
    if ('undefined' !***REMOVED*** typeof concern.w) this.options.w = concern.w;
    if ('undefined' !***REMOVED*** typeof concern.wtimeout) this.options.wtimeout = concern.wtimeout;
  } else {
    this.options.w = 'm' ***REMOVED***= concern ? 'majority' : concern;
  }
  return this;
};
...
Query.prototype.distinct = function(criteria, field) {
  ...
  if (!field && typeof criteria ***REMOVED***= 'string') {
    field = criteria;
    criteria = undefined;
  }

  if ('string' ***REMOVED*** typeof field) {
...
Query.prototype.exec = async function exec(op) {
  ...
  if (typeof this[fnName] !***REMOVED*** 'function') {
...
Query.prototype.selectedInclusively = function selectedInclusively() {
  ...
  if (0 ***REMOVED***= keys.length) return false;

  for (let i = 0; i < keys.length; ++i) {
    const key = keys[i];
    if (0 ***REMOVED***= this._fields[key]) return false;
    if (this._fields[key] &&
        typeof this._fields[key] ***REMOVED***= 'object' &&
...
Query.prototype.selectedExclusively = function selectedExclusively() {
  ...
  for (let i = 0; i < keys.length; ++i) {
    const key = keys[i];
    if (0 ***REMOVED***= this._fields[key]) return true;
  }
