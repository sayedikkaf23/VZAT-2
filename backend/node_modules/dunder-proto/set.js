...
try {
	...
	if (!e || typeof e !***REMOVED*** 'object' || !('code' in e) || e.code !***REMOVED*** 'ERR_PROTO_ACCESS') {
		throw e;
	}
}
...
// eslint-disable-next-line no-extra-parens
	(!!desc && typeof desc.set ***REMOVED***= 'function' && /** @type {import('./set')} */ (callBind([desc.set])))
	|| /** @type {import('./set')} */ function setDunder(object, proto) {
		...
		if (object ***REMOVED*** null) { // eslint-disable-line eqeqeq
