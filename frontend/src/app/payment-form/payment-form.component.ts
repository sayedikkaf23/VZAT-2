...
export class PaymentFormComponent implements OnInit {
  ...
  ngOnInit(): void {
    console.log('Payment form ngOnInit - calling getCountryRisks');
  ...
  onSubmit(): void {
    if (this.basicDetailsForm.valid) {
      ...
      if (controls['fname'].invalid) {
        this.toastr.error('First Name is required and must be at least 2 characters.', 'Validation Error');
      } else if (controls['lname'].invalid) {
        this.toastr.error('Last Name is required and must be at least 2 characters.', 'Validation Error');
      } else if (controls['nationality'].invalid) {
        this.toastr.error('Please select your nationality.', 'Validation Error');
      } else if (controls['gender'].invalid) {
        this.toastr.error('Please select your gender.', 'Validation Error');
      } else if (controls['dob'].invalid) {
        this.toastr.error('Please enter your date of birth.', 'Validation Error');
